...
By default, Thesis identifies itself to SEC as `Thesis CLI/0.1 (+https://github.com/kghoff/thesis)`. If SEC ever needs to contact someone about your traffic, they'll file a GitHub issue.
