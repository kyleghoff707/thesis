...
Good day, and thank you for joining us. Welcome to the Q3 2025 Labcorp Holdings Earnings Conference Call. Please note that today's call is being recorded. I will now turn the conference over to our speaker, Christin O'Donnell, Vice President of Investor Relations. Please proceed.
...
I would like to get more details about the announcement regarding the site consolidation in the Early Development business. Could you discuss the market factors that influenced this decision? Additionally, you mentioned the revenue impact; can you also provide insight into the potential earnings impact from this decision, considering it may be low margin?
...
Thank you for the question, Kevin. There's nothing unusual regarding the margins. The 110 basis point improvement in Diagnostics is strong, partially driven by Invitae, although there are offsets due to some hospital deals that initially dilute margins but eventually reach average levels. There are always fluctuations to consider with margins. We're also making good progress with our LaunchPad initiative, which is significantly reducing costs, nearly covering all employee-related inflation. In Biopharma Laboratory Services, we saw a margin increase of about 20 basis points. Overall, we achieved a strong margin improvement of 100 basis points for the quarter. Looking ahead to next quarter, we anticipate continued strength, especially in Diagnostics. This quarter included two to three months from the Invitae acquisition, while next quarter will encompass three full months. Additionally, we will keep making headway in other areas. However, BLS may face challenges because the first half of the year provided an easier comparison, while the fourth quarter will be much more difficult for BLS. Overall, we expect margin improvements for both businesses this year compared to last. It's too early to provide specific guidance for 2026, which we will discuss in February. We are diligently working on maximizing savings from both LaunchPad and our AI initiatives to mitigate the impact of PAMA, which affects both the top and bottom lines.
...
Yes. No, thank you for the question. And the hospital pipeline does remain strong, and I expect it to continue to be strong. When I think about the hospital business, I think about 3 different parts of it. One is running the laboratories in the hospital. Those are typically the lowest margin business, but it has a very high return on cost of capital. So we will do that business even though it's a bit lower in margin because it does have a great return on cost of capital. The second thing we look at is the reference work. So if it's business that they can't do in a hospital lab, well they send it to us as reference. And that's good margin business, about the same as our average margin. And then the third part is acquiring the outreach business, which also is about the same as our average margin. Most hospitals, when we do all 3 of those things, it ends up being about the same as our average margin. If we were to only do the hospital running of the labs, it would be lower, but that's not typical. Typically, we would do running the labs along with either the reference and/or the outreach business. So net-net, it should be neutral to margins over time.
...
Yes. If you examine what we've shared, we typically anticipate that acquisitions will contribute 1.5% to 2.5% growth in a given year. This is reflected in our longer-term guidance, and we expect to maintain that level of growth. The pipeline remains robust and positive. While we do not disclose specific operating income or margin for individual deals, I can say that when I evaluate hospital deals—factoring in all three components of the business, which include reference laboratory work, in-house laboratory work for the hospital, and the acquisition of outpatient labs—the margin tends to align closely with our average margin.
...
I want to probe on the Central Lab strengths a bit more. I understand your book-to-bill comments earlier, but can you maybe just talk about the acceleration you saw here in Q3, a nice step-up from Q2. Maybe just talk about the durability of what you're seeing now on the Central Lab side.

**Adam Schechter** *(Chairman and Chief Executive Officer)*:

Yes. So if you look at our Central Lab business, it remains strong. It had 10% growth on the top line, but it was 7% if you looked at the constant currency growth rate, which is very healthy growth. We expect that it will be in the mid-single-digit growth for the full year. That's typically where you'd expect the Central Laboratory business to grow. We're seeing strong book-to-bill. Last quarter, we announced that we had several large studies that were going to go over multiple years. The more large studies over multiple years you have, the better you are. But overall, I would say that that business, we expect to continue to grow and to do well as we look for that to offset some of the softness that we're seeing for the Early Development for the rest of the year.
