...
Good day, and thank you for being here. Welcome to the Q4 2025 Labcorp Holdings Earnings Conference Call. Please note that this conference is being recorded. I will now turn the call over to your first speaker, Christin O'Donnell, Vice President of Investor Relations. Please continue.
...
The fourth quarter organic volume increased by 1%, which is lower than usual. Is there anything specific you would like to highlight regarding this? Considering the volume trajectory indicated in your guidance for 2026, this seems like an outlier, and I would like to gain a better understanding of it.

**Adam Schechter** *(Chairman and Chief Executive Officer)*:

Yes. Let me provide some details on that, Kevin. The Diagnostics revenue reached $2.7 billion, showing a growth of approximately 6% compared to last year. The organic growth was robust at 4.1%, while acquisitions contributed around 1.5%. Delving deeper, the volume rose by 2.2%, with organic volume accounting for about half and acquisitions making up the other half. In terms of organic volume, two factors influenced it. Firstly, there were reduced referrals from a major consumer genetic client facing financial difficulties in the fourth quarter. Additionally, weather conditions played a minor role. Without these two adjustments, the growth would have exceeded 2%, aligning with the full year trend. Looking ahead to 2026, we anticipate strong growth in the Diagnostics sector at a rate of 5% to 6%, with 5.5% being the midpoint expectation. This projection assumes that the majority of the revenue growth will be organic. For the organic growth, we expect about half to stem from volume and the other half from price mix, similar to this year.

**Kevin Caliendo** *(Analyst)*:

So that one customer issue was specific to the fourth quarter, and it sounds like that won't be a recurring problem.
...
Yes. Thanks, Ann. As I assess the enterprise guidance for 2026, I feel very optimistic about it. The revenue guidance is set at 4.7% to 6%, and the EPS guidance suggests approximately 9% growth at the midpoint. In terms of the dynamics at play, I'll first focus on diagnostics. We anticipate a healthy utilization environment, supported by industry trends such as an aging population and an increase in the number of tests being conducted. There are many positive indicators in this regard. However, slight fluctuations in organic volumes could influence our position within that range towards the high end. Regarding the core business and the business development pipeline, both are strong, and the timing of M&A activity may have varying effects on our results. We have a robust M&A pipeline but will be monitoring how swiftly we can convert that into revenue. On the biopharma side, specifically with Central Labs, we expect to see solid organic growth in the mid-single digits, backed by a strong trailing 12-month book-to-bill ratio. This is largely a backlog-driven sector. Thus, I feel confident in our guidance. In early development, we anticipate relatively flat organic growth for the year, influenced partly by the pace at which we consolidate or sell the $50 million of affected revenue. We expect this impact to begin in the fourth quarter, with most transitions completed by the end of the second quarter. The timing of these activities could affect our results in either direction. Those are the main factors at play.

**Ann Hynes** *(Analyst)*:

And just as a follow-up, do you think there's any change to the competitive landscape in the diagnostic business? And when you look at like the break of test, I know there's like a lot of these consumer tests happening. How do you view your market share in those types of consumer tests versus peers?

**Adam Schechter** *(Chairman and Chief Executive Officer)*:

Yes. So I continue to believe that the diagnostic market is strong and that we will outperform, continue to perform slightly better than the overall market growth. When I think strategically of where we're focused, first and foremost, we've talked about the hospital deals and the strong pipeline that we have. Those hospital deals in the past few years have contributed to more than $1 billion of growth. Those hospital deals are overall about our average margin, and there are things that we can implement well and integrate well. So we're going to continue to focus there. I talked about specialty testing, and we launched over 130 new tests last year. The majority of those were in the four areas of women's health, oncology, neurology and autoimmune disease. We see those areas growing 2 to 3 times faster than the overall diagnostic market. So that's going to continue to be a growth engine for us, good margins. But in addition to that, when you have a specialty patient that uses your specialty test, the physician tends to use all of our testing for the patients' needs there. So it has a really good return for us. Then when I think about the consumer business, if you look at our Labcorp OnDemand, we've launched over 200 different biomarkers in areas like women's health, men's health, longevity. We will continue to focus and launch new tests there. We have our Ovia Health, which helps women throughout the stages of her life, and that's doing very well. And then we have our consumer genetics testing, which is also continuing to do well. If you look at those three together, we have very strong growth. We don't break out the dollar amount yet. It's not yet at that level where I believe it's critical to break out. But with the growth rates that I see, I expect that we will break that out at some point into the future. Where we haven't necessarily been focused is on the other areas of consumerism and some of the wearables and so forth. And those areas, we look at the pricing environment, we look at the margin environment, and we have so many things that we focus on in the other parts of our strategy. I feel that we have just tremendous opportunity before us with the focuses that we have in the areas.
...
First question is on PAMA. Adam, I would love to know how you think this is going to play out this year. Are you prepared to submit in the survey that's going to take place in a few months? And what do you think happens once the data reads out sometime in the fall?

**Adam Schechter** *(Chairman and Chief Executive Officer)*:

Thank you for the question, Jack. We're pleased that the PAMA was delayed this year. It shows that there is recognition that the original intention for it in the marketplace is not how it's functioning. However, this delay isn't sufficient. We will continue to advocate for the RESULTS Act, which I believe is the solution to our current challenges. We will collaborate with our ACI trade organization to push for the passage of that bill this year. If we need to submit the data, we are ready to do so. It’s difficult to predict the outcome since we don’t know how many others will submit data and what the implications of that may be. Nonetheless, I firmly believe that the RESULTS Act is the correct approach for the government to achieve its original objectives with PAMA.

**Jack Meehan** *(Analyst)*:

Okay. And one unrelated follow-up. You mentioned investments in the central lab business within CapEx this year. I was wondering if you could just give us an update as to what's going on there and how that's in your footprint or just where those investments are getting directed?

**Julia Wang** *(Executive Vice President and Chief Financial Officer)*:

Yes. Jack, maybe I can start by sharing a bit of our thought around the CapEx investment in 2026 in general. And then I'd like to really invite Adam to comment a bit about the business considerations and the footprint planning for central lab in particular. So for 2026, we commented that we are expecting the CapEx investment around 4% of our revenue in the year, which is higher than prior years. And as we shared in the past, as you look at the priority areas in terms of the CapEx investment, it's primarily around refreshing our lab infrastructure as well as our technology investment to ensure that we create a set of experiences for our customers, our patients and our employees that are compelling and differentiated. Now this year, in addition to those areas of investments, we are also starting to plan to invest in an expansion of a new strategic site for the central lab business in order to support the long-term growth. And that investment in addition to all the ongoing investment is contributing to the overall planning for CapEx. With that, Adam, do you want to comment a bit about the business considerations?
...
Okay. Great. And then a follow-up here. Can you talk about sort of the new test you're launching in oncology? You've had some interesting studies in peer-reviewed journals recently. How do you think about those tests launching and the revenues associated with those tests in the next sort of 12 to 24 months?
...
I just want to follow up on a few things from a guidance perspective. First, when we last spoke, you had talked about a potential headwind around the exchanges and perhaps Medicaid. So I just want to understand, one, what's in your guidance? Two, we had pretty severe weather in the Northeast in January. So just curious if you had any impact as it pertains to weather here in the first quarter. And that really leads to how do we think about the cadence of numbers? Should we think about that having some kind of impact in the first quarter? Or can you make it up within the quarter? And then just lastly, Julia, you mentioned that the enterprise margins had expanded by 50 basis points, and you expect it to be meaningful again in '26. Should I take that as it should be another roughly 50 basis point expansion?

**Julia Wang** *(Executive Vice President and Chief Financial Officer)*:

Yes, Lisa, let me address your first question regarding the expiration of the ACA tax credits. We estimate that this will lead to about a 30 basis point decrease in our diagnostic volume in 2026, and this has been factored into our revenue guidance for this year. Additionally, reported enrollment this year has been slightly better than we expected. We are closely monitoring the utilization of this insured group as the year unfolds. Regarding your second question on weather impact, we did encounter worse weather in January this year compared to last year. However, our guidance has already accounted for this weather impact year-to-date. While we do not typically provide specific quarterly guidance, I can suggest that the cadence for this year might closely mirror last year's performance. Looking at 2025, we generated about half of our earnings in the first half of the year and the other half in the second half, which could serve as a useful reference for your modeling. As for margins, I previously mentioned our strong focus and priority on making targeted investments that drive accelerated top line growth. We are also leveraging technology to enhance our operational efficiency and the value we deliver to our customers and patients. While we do not offer specific margin guidance, based on our revenue growth midpoint of 5.4% for the enterprise and our adjusted EPS growth midpoint of 9% for 2026, you might infer a margin expansion that aligns with our adjusted EPS guidance. Overall, we are pleased with the strength of margin expansion in 2025, and we anticipate that this trend will continue into 2026.
...
Maybe I have one modeling question and one longer-term question. Initially, when we were considering whether PAMA would be delayed until 2026, there was mention of potential additional savings of about $25 million to $30 million if it proceeded as planned. Julia discussed this in traditional terms. Are those potential savings still seen as a possible upside as we go through this year, or should we view them as necessary investments required for achieving higher revenue rates? Additionally, regarding the early development business, there have been concerns about possible changes in behavior from pharma and biotech with the introduction of new AI applications. Are you currently noticing any of this in client requests, or is this something you see as a potential future development that isn't happening right now?
...
I'm wondering if you could add a little bit of color on esoteric testing, what you saw in the fourth quarter, just how that played out relative to expectations, just if there's been any changes in the market there? And a small follow-up to what you called out earlier in terms of the 4Q volume weakness that you called out sort of a consumer genomics business. Just clarify, is that a one-time hit? Or do you expect that to continue to be a little bit softer in 2026? And just sort of what was behind that? Was that just timing? Or just explain that a little bit more.

**Adam Schechter** *(Chairman and Chief Executive Officer)*:

Yes. It was, in our opinion, a one-time hit, and we've actually seen good recovery, and we have additional business that we brought in into that area. So as I look at 2026 and we provide the guidance for 2026, you can see that we expect the volume to be strong.
...
So that suggests to me that you're either being very aggressive with that formula or you had strong bookings or good signs regarding your expectations for that business, considering you are addressing the $50 million impact from divestitures and cost measures. What market indicators give you that level of confidence?
