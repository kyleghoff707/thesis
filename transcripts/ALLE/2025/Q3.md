...
- **Michael Wagnes** — Senior Vice President and CFO
...
Yes. If you think about the Americas, I talked about this earlier in the year. Inflation, especially associated with the tariffs, right, was a little quicker than some of the pricing benefits. We said that would improve as the year progressed. You see that in the third quarter. The big item for us on the pricing side is what is inflation and tariffs are a component of that inflation. Just look for us to drive pricing and productivity, and you've heard me mention this many times before. Pricing and productivity cover the inflation and the investment, and that helps drive the margin expansion. Overall, I feel good about the progress we're making in the Americas. I think we're doing a great job in combating a very dynamic environment of change when you think about tariffs, and expect us to continue to drive that margin expansion that we talked about.
...
I want to come back to the deals, really kind of maybe a two-part question. First, just thinking about sort of everything that you've done here. It all looks like it makes sense and fits in and is nicely moving the needle as we've seen your results. But just thinking about kind of the margin entitlement of what you've acquired, where you might be on integrating these assets? Are they all truly being integrated or any of them sort of stand-alone? Just trying to kind of get my head around kind of the journey you're on here.

**John Stone** *(President and CEO)*:

I appreciate your question, Jeff. If you remember our Investor Day discussion, we emphasized the importance of being disciplined. Some of the key principles guiding our discipline align with our strategy, geographical presence, and the markets where we have a competitive advantage, such as brand strength, talent, and distribution capability. To specifically address your inquiry, all of these acquisitions are being integrated swiftly, and I see significant synergies in terms of revenue and cost. We also have access to faster-growing segments that we've brought on board. I am very optimistic about how strategically aligned each deal is and I maintain a positive outlook on our acquisition pipeline. However, we are not planning to expand into new areas or geographies; we will focus on enhancing our product portfolio in electronics, mechanical, and complementary software within markets where we excel. You can expect us to pursue acquisitions, but we will remain disciplined, as we have demonstrated so far.

**Jeffrey Sprague** *(Analyst)*:

Discipline also involves considering the price paid. I understand that each deal is unique, making it challenging to ask Josh or Mike for specific multiples. However, could you provide an overview of the total dollars deployed year-to-date and what the average multiple has been? Additionally, when evaluating synergies, can you share what the forward multiple might look like over the next 12 to 24 months as we integrate these acquisitions?
...
The biggest acquisition is ELATEC, which represents the majority of our activity. We provided this information when we announced the acquisition and published our press release. You can refer to that to get a good understanding of the acquisitions and identify the largest component based on the multiple paid.
...
To address your question about the residential outlook, I apologize for the earlier phone issues. Overall, the demand for residential products has been weak for some time. In the third quarter, we saw some benefits from the introduction of new products, specifically the e-locks we launched, which included the Arrive lock mentioned during the first quarter earnings call. Even though we experienced some positive effects from this launch, market demand for residential is consistent with year-to-date growth rates, which indicate a slight decline. Looking ahead to the fourth quarter, we do not anticipate mid-single-digit growth; rather, we expect the performance to align with the current market demand, which remains weak in the residential sector.
...
Tomo, this is John. I appreciate your comment. I believe our teams and customers have responded well to the inflation driven by tariffs. Overall, our industry is adjusting with price realization. As Mike mentioned in the prepared comments, we are prepared to address ongoing inflationary pressures with pricing. The demand environment in nonresidential is good and healthy, and I haven't observed any signs of fatigue.
...
Tim, that's a great question, and I appreciate you bringing it up. Regarding spec content, we're observing an acceleration in the adoption of electronics, which is reflected in our specifications as well as in the growth figures for electronics that we've been sharing lately. We're quite pleased with this progress. Additionally, our recent product launches in the nonresidential sector are yielding positive results. We're also beginning to see, albeit on a small scale, opportunities to incorporate some of the complementary software we've created organically into multifamily applications, which is exciting for us.  As for our new acquisitions, several of them, like Krieger Specialty Products in the nonresidential Americas, align perfectly with our specification engine, and we're eager to witness growth in this area. Recall that this acquisition added products to our hollow metal portfolio that were previously missing, including high-margin, fast-growing niche products that present great opportunities for new customer specification. Another strong example from this year is Trimco, known for high-end specialty hardware for commercial applications. If you had surveyed our channel customers over the past few years, they would have pointed to Trimco as an ideal acquisition target for Allegion, so we're thrilled to have that team join us. It seamlessly integrates with our specification engine, and we're encouraged by the momentum we're seeing.

**Timothy Wojs** *(Analyst)*:

Okay. That's great to hear. And then maybe just on the modeling side. Just in International, kind of the opposite of Julian's question on PPII, that flipped negative this quarter. Is that just a timing consideration? Or is there anything to read in there around price, productivity and inflation?

**Michael Wagnes** *(Senior Vice President and CFO)*:

Yes. If you think about margins in International, good performance this quarter. It was slightly negative on the PPII. On a year-to-date basis, though, Tim, think of it as it's negative like $1 million if you add up the three quarters. So it's essentially covered. And look for us in International to cover that inflationary pressure. So I wouldn't look too much into the third quarter at all. Look at the year-to-date rate, and you get an idea; we're doing a pretty good job there.
