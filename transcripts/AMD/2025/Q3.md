...
- **Operator** — Operator
- **Matthew Ramsay** — VP, Financial Strategy and Investor Relations
- **Lisa Su** — CEO
- **Jean Hu** — CFO
- **Vivek Arya** — Analyst
...
Greetings, and welcome to the AMD Third Quarter 2025 Conference Call. As a reminder, this conference call is being recorded. It is now my pleasure to introduce Matt Ramsay, VP of Financial Strategy and Investor Relations. Thank you, Matt. You may begin.
...
And the first question comes from Vivek Arya with Bank of America Securities.
...
Yes, absolutely, Vivek. We're very excited about our relationship with OpenAI, as it's a significant partnership. This is a unique time for AI with a high demand for compute across various workloads. In our collaboration with OpenAI, we are planning several quarters ahead to ensure that we have the necessary power and a stable supply chain. The important point is that we will begin deploying the first gigawatt in the second half of '26, and that work is already in progress. Given current lead times, we are closely coordinating with OpenAI and the CSP partners to make sure we are ready to deploy the technology as planned. Overall, we are working well together, we have good visibility into the MI450 ramp, and things are progressing positively.
...
Sure, Tom. What you're highlighting is something the entire industry needs to address collaboratively. We need to coordinate our plans as a collective ecosystem, and that’s precisely what we are doing. We are engaged with our customers regarding their power strategies for the next two years, focusing on silicon, memory, packaging, and the entire supply chain. We are also collaborating closely with our supply chain partners to ensure the necessary capacity is accessible. Based on what we can see, we are confident in our robust supply chain, which is ready to support significant growth rates and the considerable demand for compute power. While the situation may become challenging, we have noticed an increase in capital spending indicating a push for more compute resources, and we are committed to working together effectively during these tight conditions. We anticipate improvements as we secure more power and supply. Overall, we believe we are well positioned for substantial growth as we move into the latter half of 2026 and into 2027 with the MI450 and Helios.
...
Sure, Josh. I've been observing the CPU server side trend for a few quarters now, and we've started to see some positive signs in CPU demand a couple of quarters ago. As we move through 2025, there's been a broader increase in CPU demand. Several of our large hyperscale clients are now predicting substantial CPU build-up into 2026. This leads me to believe that the demand environment is favorable because AI is driving a significant need for general-purpose computing. This aligns well with our Turin ramp-up, which has progressed very quickly, and we are also experiencing strong demand for our Genoa product line. Looking ahead to 2026, I expect the CPU demand environment to remain positive. We will provide more guidance towards the end of the year, but I anticipate sustained demand for CPUs as this trend continues. I believe this demand is robust and won't be short-lived; it seems to be a multi-quarter trend driven by the increasing requirements of AI workloads.
...
Yes. But could you just directionally tell me which one grew more than the other? I'm not even asking for numbers, just directionally.
...
The server segment showed slight improvement. Regarding guidance, you mentioned that the data center overall is growing in the double digits, and servers are experiencing strong double-digit growth. Could you clarify what you mean by strong double digits? Is that over 20%? Additionally, for the GPUs this year, you indicated a figure around $6.5 billion last quarter. Do you anticipate staying in that range? It seems like you're still on track to meet that expectation.

**Jean Hu** *(CFO)*:

Stacy, here's what we communicated. We indicated that data center will increase by double digits sequentially, and we mentioned that server will see strong growth. Additionally, we noted that MI350 will also ramp up. Therefore, I don't believe what you just referenced aligns with our guidance.

**Lisa Su** *(CEO)*:

No. Look, Stacy, let me say it. Data center will increase sequentially by a strong double-digit percentage, and both server and data center AI will also see growth. Overall, we are satisfied with their performance. The strong double-digit percentage remark was likely referring to the year-over-year comparison.
...
Sure, let me mention a few things. Firstly, the OpenAI deal has been in development for a while, and we're pleased to discuss it in detail, including the scale of the deployments and engagement, which are both multiyear and multi-gigawatt. All of this is very positive. We've also had various other engagements. If you were to ask about the last month specifically, I would say there have been several factors at play. The OpenAI deal was one of them, and showcasing the Helios rack in full capacity at Open Compute was also a significant milestone because it allowed people to see the engineering and capabilities of the Helios rack. Regarding whether we've noticed an increase in interest or a faster pace of interest, the answer is yes. Customers are generally engaged and possibly at a higher scale, which is encouraging. Additionally, having a wide range of customers is crucial for us in this business. We have consistently engaged with many customers, and we're structuring the supply chain to ensure we have ample supply for multiple customers at similar scale as we approach 2027 and 2028, which is certainly our objective.
...
Yes. On the server CPU side, Turin is indeed showing more content, resulting in higher average selling prices as it gains traction. However, as I mentioned earlier, we are also observing solid demand for Genoa. While Turin is ramping up quickly, Genoa demand remains strong because hyperscalers cannot transition everything to the latest generation immediately. Therefore, we perceive broad-based CPU demand across various workloads. Some of this can be attributed to server refresh cycles, but from discussions with our customers, it appears that the rise in AI workloads is leading to an increased need for traditional compute, necessitating more build-out. Looking ahead, we sense a growing interest in adopting the latest generation. While we are pleased with Turin's ramp-up, we are also seeing a strong demand for Venice and significant early engagement, highlighting the critical role of general-purpose compute at this time.
...
So I'd like to ask about whether the developing relationship with OpenAI could be a tailwind to the development of your software stack. Can you maybe tell us about how the collaboration works in practice and whether the partnership contributed to making ROCm more robust?

**Lisa Su** *(CEO)*:

Yes, Antoine, thank you for the question. The answer is yes. All of our large customers play a role in broadening and deepening our overall software stack. Our collaboration with OpenAI is particularly focused on working together on hardware, software, systems, and the future roadmap. The work we're doing with them on Triton is very valuable. Beyond OpenAI, our efforts with all our largest customers are extremely beneficial in strengthening the software stack. We have invested significant new resources not just in the largest customers, but also in a wide range of AI-native companies who are actively developing on the ROCm stack. We receive a lot of feedback, and we've made notable progress in the training and inference stack. We plan to continue investing heavily in this area. The more customers that use AMD, the more it enhances the ROCm stack. We will discuss this in more detail next week, but we are also leveraging AI to help accelerate the development of some ROCm kernels and the overall ecosystem.
...
I believe we are starting to see some initial signs of this. The main point is that there is definitely a desire to utilize the latest and most advanced GPUs when constructing new data center infrastructure. For instance, the MI355s are frequently found in new liquid-cooled facilities, as is the MI450 Series. Additionally, there is another trend emerging, indicating a growing demand for more AI computing resources. From this perspective, some of the older generation, like the MI300X, are still performing well, particularly in deployment and usage for inference. So, it appears we have a combination of both trends.
...
Okay. But do you have product to support that market if it opens up? Or will you need to start rebuilding inventory for that?
...
Great. As a follow-up, I'm curious about the unique structure you implemented by granting some warrants with this deal. They vest according to a price that would be beneficial for everyone involved. Do you think this arrangement is relatively unique, or do you see AMD being open to similar creative approaches in the future to meet the increasing demand for processing power, perhaps using other equity vehicles?

**Lisa Su** *(CEO)*:

I would say it was a unique agreement considering the current time in AI. What we prioritized was a deep partnership that spans multiple years and generations at a significant scale, and I believe we achieved that. The structure we established has aligned incentives where everyone benefits—us, OpenAI, and our shareholders. This arrangement supports our overall roadmap. Looking ahead, we have numerous interesting partnerships in development, whether with major AI users or in sovereign AI opportunities. Each of these presents a unique chance for us to leverage all of AMD's capabilities. While OpenAI was quite unique, I believe there are many other opportunities for us to integrate our capabilities into the ecosystem meaningfully.
