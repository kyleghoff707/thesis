...
- **C. Howard Nye** — Chair and Chief Executive Officer
...
- **David Sutherland MacGregor** — Analyst
...
The first question will come from Kathryn Thompson, Thompson Research Group.
...
Trey, thank you for the question. I'm going to turn that over to Michael to talk about some of the specifics. I'll give you some broad strokes on that. So if you really think about it strategically, we're building, as I've indicated before, an aggregates and mag business, and it's going to be heavily emphasized on the aggregates piece of it. If you think about the criticality, though, to your question on magnesia, the business that we've had, very impressive business, high margins, just had a record quarter, and it's primarily synthetic magnesia. If you look at the business that we just acquired, it's more natural magnesia. And what's important to remember is they both begin with varying degrees of overlap, and I think it's easy for the uninitiated to look at mag and ag and not have a sense of how tightly they overlap and what the required skills are between the 2 and how they go back and forth. Obviously, Michael drove that process before he started wearing 2 different hats. So I'll ask him to go back and talk a little bit about what that business looks like and what you can expect from a contribution perspective.
...
First, I would like to clarify something. Was there any special item in the $4 million of corporate, as it seems a bit low? My main question is to ensure I understand the volume message correctly. The new guidance indicates an expectation of about 3 million tons lower than what was initially projected in the first quarter. Could you explain how this breaks down between Q2's weather impact and other factors? Is this lower guidance an effort to avoid being overly optimistic? It seems there might still be some potential for upside since you mentioned seeing a bit more positive momentum.
...
Yes. The question pertains to corporate expenses or SG&A for the quarter, and two key factors are influencing the comparison to previous periods. Firstly, the only adjusted metric we report now is adjusted EBITDA, and last year, about $20 million of acquisition-related expenses were added back to EBITDA, which falls under corporate expenses. Secondly, the other aspect of the comparison is effective SG&A cost management, which we have been focused on. These are the two main factors if we're looking at EBITDA growth of 8% and net earnings growth in double digits, which was impacted by the adjustment for acquisition expenses.
...
Yes, we would generally consider a run rate of around 7% of sales for a full year as a solid modeling number for SG&A as a percentage of sales. While it may fluctuate slightly between quarters, I believe maintaining 7% in your model is a good approach.

**Operator** *(Operator)*:

Up next, we'll hear from David MacGregor from Longbow Research.

**David Sutherland MacGregor** *(Analyst)*:

Congrats, and Mike, on the transaction for this quarter.
...
Yes. On the tons that you've acquired, the 20 million tons, just how would you characterize the pricing on those tons within the context of their respective markets? Are they underpriced? Are they fairly priced? Is there a future ASP lift opportunity? And then if I could just squeeze in maybe some commentary around the rail mergers and the potential impact there?
...
I'm speaking for Keith this morning. Aggregates pricing remains strong, and last quarter was no exception. However, prolonged weather issues have affected volumes over several quarters, and we understand that this influences the timing of price realization. Can you provide insight into whether weather has affected pricing in the industry? Additionally, is this a gap that could close if we experience 12 months of significantly below-average rainfall?
...
It's great to hear from you, Brian, and I appreciate your question. No, the land purchases tend to be more adjacent. I believe that's a more constructive approach today because while we do have greenfield options available, I prefer to expand existing operations. Think of it this way: if you acquire the property next door and already have necessary setbacks, you're not just acquiring that land for expansion; you're also unlocking some of your own reserves that were previously limited by those setbacks. So, by purchasing adjacent reserves, you see multiple benefits, which is the primary strategy we're pursuing. Practically, when we assess quarries with less than 20 years of life, it raises a flag for us, signaling the need for action. While we have very few of those cases, on occasion, we do encounter opportunities to buy land next to valuable operations, often at prices that don't reflect the value generated when the property is under our management, and we act on those. This is the main focus of our recent activities. As Michael mentioned in his prepared remarks, our capital expenditures have been above historical levels in recent years, but we expect them to return to more standard levels next year. To directly address your question: no, it's not greenfielding; it is adjacent reserves, and that's the philosophy guiding our strategy.
...
Thank you, Ivan. We'll be meeting early next month at the Mandarin Oriental in New York. As you know, we refresh our SOAR plans every five years, which we have done with each SOAR plan. I’m not saying this is what we will discuss, but historically, we've managed to double our market cap every five years. I believe the company has an exciting growth path ahead. I want to share that with you, along with the promising regions we'll be focusing on. There are also many new tools emerging, particularly regarding developments in the industry and our business, which I want to address. I’m proud of our outstanding team, and I want you to have a closer look at what they can do. This is about long-term market strategies. It’s also about exploring what potential mergers and acquisitions could mean for us over the next five years and beyond. We will provide insight into our marketing approach and the increasing sophistication brought to our efforts. You will see what I believe to be the most talented team in the industry, and I want to ensure you, the investors and others, have time with them to confirm my assessment – I think you will be impressed with what you see.
