...
- **John C. Griffith** — President and CEO
- **David M. Bowler** — CFO
- **Cheryl D. Norton** — President of Regulated Operations
...
Good morning, and welcome to American Water's Second Quarter 2025 Earnings Conference Call. As a reminder, this call will be recorded and is also being webcast with an accompanying slide presentation through the company's Investor Relations website. The audio webcast archive will be available for 1 year on American Water's Investor Relations website. I would like now to introduce your host for today's call, Aaron Musgrave, Vice President of Investor Relations. Mr. Musgrave, you may begin.
...
Our first question comes from Richard Sunderland of JPMorgan.
...
Rich, this is David. Thanks for that question. Obviously, we keep all options on the table and are always evaluating the options that we have to issue, but our plan is to take proceeds in 2026 and issue the equity in '26.
...
No, I don't think that it's going to have a negative impact at all. I believe we will just incorporate them seamlessly and continue to move forward, and I don’t foresee any negative consequences at all.
...
Jonathan, it's John here. I'll add to Cheryl's comments, and she is correct about the Pennsylvania landscape. We are seeing increased contributions from across our entire platform as well. Pennsylvania remains strong, but the same factors driving Pennsylvania, such as the need for investment and economies of scale leading to regionalization, apply to our entire platform. We have spent the past couple of years preparing to leverage these dynamics across our states.

**Jonathan Garrett Reeder** *(Analyst)*:

It's great to hear about the widespread momentum. I have another question regarding your mention of the decoupling bill in California. Could you elaborate on what that bill entails or its objectives? I believe the legislature passed a decoupling bill last year, but it didn’t mandate the commission to implement decoupling. Does this new bill require them to fully approve decoupling for California's water utilities?
...
Yes, it's passed out of the appropriations committee and will now go to the full legislature. Once it passes there, it will head to the governor's desk.
