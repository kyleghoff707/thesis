...
Good morning, and welcome to Deere & Company's Third Quarter Earnings Conference Call. I would now like to turn the call over to Mr. Josh Beal, Director of Investor Relations. Thank you. You may begin.
...
Sure, I'll begin, and Cory can chime in as well. Regarding planters, we are currently a bit more than halfway through the program. Given the market uncertainty over the past month and a half to two months, ordering for planters has been somewhat cautious. Customers have the option to wait until the end of the program, and we typically observe an increase in orders towards the latter part of the early order programs, particularly in this type of environment. So, it's still early in the planter program. For combines, as we noted, it started on August 1, so it’s very early. The initial feedback is positive, but we need more time to gauge that segment properly. Cory, do you have any additional insights on what we’re observing?
...
Thank you for the question, Steve. There are several factors to consider here, and I appreciate the chance to elaborate. In the fourth quarter of 2024, we implemented additional incentives for pool funds. As a result, we expect a lift in the fourth quarter of 2025 due to this timing. Additionally, we are beginning to see pricing for some model year 2026 products, as we will start shipping model year 2026 sprayers in the fourth quarter of this year. The average pricing for next year's sprayers is expected to be between 4% and 4.5%, contributing to some of this price increase. Furthermore, pricing for model year 2026 equipment in Brazil will also begin shipping in our fourth quarter, providing an additional year-over-year boost.

**Joshua Jepsen** *(Chief Financial Officer)*:

Steve, this is Jepsen. One thing I'd add to that. I mean, Josh mentioned starting to ship model year '26 in Brazil and in North America. But Brazil, coming off of last year where we ran some negative price, this year, we're mid-single digits positive. So that's returned, which is a good thing. And given the growth in that market for us over the last decade, it was more meaningful when we look at price.
...
The question is about the cash flow guidance, which is in the $1 billion range with only a quarter remaining. I'm interested in how much of that might be affected by potential differences in outcomes regarding channel inventory. It seems you're indicating that you've finished underproducing, but the fourth quarter can always show some variability in production. How are you approaching channel inventories and considering the initial outlook for 2026? There's a lot to unpack, but could you clarify why there is such a wide range in the operating cash flow guidance with just one quarter left?

**Joshua Jepsen** *(Chief Financial Officer)*:

Tim, it's Jepsen. I'll start by saying we are confident about our inventory projections for the year-end. Beal reviewed the reductions we have implemented. For instance, in North America, our inventory-to-sales ratio for items with 220 horsepower and above is currently around 20%, which is the same percentage as last year, although the absolute number of units is lower. We have successfully reduced our inventory and feel positive about our year-end position. There is some work left to do in small agriculture and turf, as Josh mentioned, but we have observed significant progress and an increase in retail activity. We believe our forecast for that segment is appropriate. Our cash flow range remains unchanged, reflecting the uncertain market conditions. Even if we had tightened it, the midpoint would not have shifted. Thus, there hasn’t been much change in our cash flow forecast compared to the previous quarter. This has been a strong quarter that boosts our confidence in continuing to generate cash to fund the business.
...
Kyle, this is Jepsen. I want to emphasize what Beal mentioned. We've noticed strong competition, but the market is responding. Contractors currently have more work than ever, and I've spent significant time with them over the summer, observing a lot of activity. Labor remains a challenge, leading to increased competition in bidding, but there is still ample activity. We also saw a robust quarter from a retail standpoint, with increased orders as Beal pointed out. The fundamentals are solid. Bonus depreciation could benefit us as we approach the end of our fourth quarter and the calendar year. There are several positive indicators regarding demand, and we believe stability in pricing will also be advantageous. That's our expectation as we move into the fourth quarter.
...
Yes. I would like to add to that, Chad, regarding the demand side and the fundamentals for our customers. As we consider renewable fuels, there has been recent bipartisan support for ethanol, notably with RVOs and E15. I believe the potential for increased demand for ethanol, particularly with energy being included in trade agreements, presents a significant opportunity for agriculture.
...
Yes. Thanks, Jamie. I think from a tax perspective, there's a lot in there. I think we're still sorting through and how those things impact. One of the big ones is R&D expensing versus capitalization. I think over time, that will be a positive for us. And there's a lot of other puts and takes. But I think broadly, I'd say from a tax policy perspective, I think it is beneficial for the company as well as for customers. I mentioned bonus depreciation on the construction side, where we see opportunities there. But Cory, anything you'd add from your side?
...
I just wanted to understand the factors affecting margins for next year. I know you'll be producing in line with retail, but that's somewhat uncertain. If you could clarify the margin dynamics regarding pricing and production efficiencies, that would be helpful.
