...
Thank you. And as a follow-up, can you discuss will you be able to maintain your CapEx outlook or do you have any intention to move around your manufacturing locations to avoid tariffs? Thank you.
...
Hi guys, thanks for the question and welcome Phil and Kris, sorry to see you leave. Phil, you mentioned some wireless excellence at the company and looking at adjacent markets also, you came from the IoT world previously. Could that be an adjacency for you, whether it's cellular or unlicensed?

**Philip Brace** *(CEO)*:

Yes, look, I'm not going to comment on particular areas of focus there. Obviously, I came from the IT side, but I would say my purview is a very wide, wide landscape. I mean, some of our core technologies are, you know, acoustic resonators, filter design, some of the core processes that are involved in that packaging, multi, multi-chip packaging modules, very tight integration. I mean, the technology required to deliver some of our solutions is just incredible. And so, you know, I look to a wide, a wide range of things where we could go there. So, I'm not going to comment on specific, specific areas, as you might guess.

**Christopher Rolland** *(Analyst)*:

Fair enough. And then secondly, saw and typically lower frequencies. You have made a push into BAW, but we haven't had any major updates there, I think in a little bit. Is this a focus for you and is there kind of, do you see any evidence of greater traction in BAW moving forward and doubling your efforts there? Thanks.

**Philip Brace** *(CEO)*:

Look, I think BAW is like a critical component of our technology and we remain significantly invested in that and we've got a very robust roadmap going forward. And so I think we've seen good traction in that and that continues to be a cornerstone of our investment.
...
Hey guys, thanks for taking my question and Phil, Mark, congrats on the roles. Look forward to working with you. A tactical one first and then a longer-term one in the March and the June quarter. Can you guys give what Android did in both of those quarters in the mobile business?

**Kris Sennesael** *(CFO)*:

Yes. So Android was in the March quarter flat on a sequential basis. So, in that call it on about $70 million range. But we do expect a sizable sequential bump up in the June quarter for Android.
...
Great, thank you. This is Jamal Cohen for Tim. Phil or Kris, I wanted to double click on the guidance specifically what changed versus 90 days ago, what segments you've seen improve, what got worse? And can you speak to that bump up in Android in the June quarter? What's driving that?
...
Got it. And then one quick one on pricing at your largest customer. Do you expect to see any sort of pricing pressures in the coming quarters, given the most recent tariffs?
...
Our next question comes from Peter Peng at JPMorgan.

**Peter Peng** *(Analyst)*:

Hey, guys, thanks for taking my question. You guys talked about seeing seasonal trends on the wireless side for the March and June quarter. But then when you listen to the earnings call from your largest customer, they're clearly talking about some inventory build for some tariff mitigation. So I'm just wondering why there's this kind of discrepancy between what your end customer is saying and between some of the suppliers we're seeing.
...
Got it. Okay, that's helpful. And then just for the broad markets. You guys are back in the year-on-year growth for a number of quarters now. Can you maybe just talk about within that bucket which markets are showing year-in-year growth, which still has some work to do to get to a year-on-year growth trajectory?

**Philip Brace** *(CEO)*:

Yes, this is Phil. I'll respond to that. The biggest factor supporting our growth is Wi-Fi 7, which is still in its early stages. Currently, only a small percentage of devices are using Wi-Fi 7, so we have significant opportunity ahead. Automotive is another area where we're seeing positive year-over-year growth, especially as more vehicles become connected, regardless of their fuel type. On the infrastructure side, however, we have some challenges. Progress is slow, with fluctuations in growth. While we expect to see some improvement, that area requires more attention to achieve consistent growth in the future.
...
Hey guys, thanks for taking my questions and welcome Phil and Mark. How big was a large customer in the quarter? And directionally, how is their broad markets piece performing? Thanks.
...
Thank you. Regarding the gross margins, they are maintaining a steady level above 45% even though we anticipate a slight decline in revenue next quarter. How are you managing to keep these margins above 45% despite lower utilization levels? Thank you.

**Kris Sennesael** *(CFO)*:

Yes, well, if you look at the June quarter, you have mobile being down sequentially and broad markets being up sequentially. And so you have a continuous benefit there from a mix point of view, as I said before, even within broad markets, we see some mix shifts that are favorable for gross margins, and that's why we're comfortable to guide to this 46%, 47% range for the June quarter.

**Operator** *(Operator)*:

And we'll go to our next question from Vivek Arya at Bank of America.

**Unknown Analyst** *(Analyst)*:

Hi, this is Liam Farr on behalf of Vivek. Thank you for taking our questions. I'm looking at the Android market. You've been somewhat selective in pulling back in certain areas of the Android ecosystem. As AI and RF complexity increase, how do you plan to reengage more deeply with Android OEMs to capture additional content? Or are you maintaining your focus primarily on the high-end segment of the Android ecosystem? Thank you.

**Philip Brace** *(CEO)*:

We are always open to collaborating with customers where we can create value and ensure that our solutions are economically viable for us. If there are trends that align with this, we will certainly seek to capitalize on them. Our approach is based on an economic return on investment perspective. The opportunity cost for engineers is significant, as many of these solutions are complex, highly engineered, and integrated. We prefer environments where we can provide value to the customer and receive appropriate compensation. Therefore, we will continue to seek out those types of solutions.
...
I can't comment on specific matters, but we've been deeply engaged with that customer and all our customers in general for an extended period. There is a typical investment design cycle that occurs annually. Often, we invest proactively to develop technologies for the future. We continuously evaluate our performance, akin to reviewing game film in sports, assessing what we did well and what could be improved. We conduct competitive analysis, exploring the limits of our technology while delivering components that get benchmarked against competitors. If we perform well, we achieve success, and that's our goal. I don't see any changes in the dynamics. Regarding our ability to adapt, I believe the best approach is to continue executing effectively. This customer is demanding and requires significant attention. However, it’s such a substantial client that we must maintain our efforts consistently throughout the year.
