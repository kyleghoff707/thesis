...
In terms of resiliency and risk, we have a complex supply chain. There is always some level of risk involved. I wouldn’t suggest otherwise. Some time ago, we recognized that relying on a single location posed significant risks. Over time, we’ve opened up new sources of supply for certain parts of the supply chain, though not for the entire thing. We anticipate this trend continuing in the future. I’ll let Kevan address the other question.
...
Let me make a couple of comments on that before Kevan. We strongly disagree with the case yesterday. We have complied with the court's order and we plan to appeal. Regarding the DOJ case with Google, that is still ongoing and I don’t have anything further to add at this time. We are closely monitoring these situations. However, as you mentioned, there are risks involved, and the outcomes remain uncertain.
