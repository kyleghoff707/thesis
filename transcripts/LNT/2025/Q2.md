...
Yes, great question, Julien. I believe I understood most of your inquiry. To start, we have been focused on providing our investors with a clear perspective rather than getting caught up in hype and possibilities. When we refer to mature opportunities, we mean those where we are actively discussing and have high confidence in closing deals. The reference to QTS-Madison signals a significant CapEx that is not included in our plan. In terms of timing and relative size, think of it as slightly more than half of what we've mentioned about QTS-Madison. Now, regarding the Cedar Rapids site, we anticipate load expectations as follows: about 200 megawatts in 2026, starting at around 300 megawatts in 2027 and increasing to 1,000 megawatts, reaching a full 1,600 in 2028, with the remaining coming in 2029. I hope this gives you some clarity. Additionally, I want to highlight the QTS press release, which you can find on their website. In it, Kim Reynolds states that this is the largest single investment in Iowa's history, featuring state-of-the-art data center technology and a closed-loop water system. We are thrilled to welcome QTS to Cedar Rapids, and as you know, Julien, we are committed to bringing these opportunities forward more quickly, with a strong focus on capturing near-term growth.

**Julien Patrick Dumoulin-Smith** *(Analyst)*:

It's just phenomenal. Let me clarify this. How do you think about crystallizing this into an updated plan? It's been so dynamic with you. I'm curious how you think about repackaging this in an updated outlook and the timeline for that.

**Lisa M. Barton** *(President and CEO)*:

Yes. So Q3, we'll be updating all of our investors with respect to the progress that we've made on finding ESAs and the CapEx associated with that. And just a reminder, we have an incredibly flexible resource plan. So what that resource plan allows us to do is adapt regardless of what happens, quite frankly, coming out of the treasury from a guidance standpoint. It allows us to grow at the pace of our customers because we can modify that. Remember, we don't have to go in for a litigated resource planning process where we have to wait 18 months, three years and see what white smoke comes out. So we're feeling very, very well positioned to be able to identify the specific generation that's going to be tied to our growth aspirations here and for those of our customers' opportunities.
...
Thank you for the detailed information, and congratulations on the significant updates. My first question is for clarification on the last items mentioned. The $10 billion is certainly an enormous figure, yet the chart remains the same. My question is whether you have already factored in a lot of that amount? I believe you mentioned it falls under mature opportunities. However, when I examine the number shown, it appears to be around 1 gigawatt. Can I interpret that as an estimate of the potential scale of this project?

**Lisa M. Barton** *(President and CEO)*:

No. So let's just break this down because we've got two QTS data centers here. So the one that is tied to the $10 billion worth of physical investment that they're making in Cedar Rapids, that has been already in our plan in the green. QTS as well as other opportunities that we are continuing to work on where again, we have a high confidence level, and we're already in active negotiations is QTS-Madison and in the dark blue. So we will, as these opportunities in the dark blue mature, update our CapEx plan and, as I certainly noted in our opening remarks, we really do see on a going-forward basis that there's going to be closer alignment between new load and new generation. Does that help?

**Andrew Marc Weisel** *(Analyst)*:

Okay. Yes, it does. And then maybe going one step further. Based on the commentary, it sounds like both projects maybe would require new generation and therefore CapEx? I know you'll give us an update like you typically do with the Q3 around EEI, but maybe you can qualitatively talk about what that might look like; would you maybe need some CCGTs in the plan?

**Robert J. Durian** *(Executive Vice President and CFO)*:

Andrew, if you think about the mature opportunities that we've identified that are in the blue, think of that as roughly about 1.5 gigawatts of potential new load that we characterize as in advanced negotiations at this point in time, including the QTS-Madison project that's reached an agreement in principle. As we finalize those energy supply agreements, then we will build into our capital expenditure plan in the future, the resources that we need to serve those. As Lisa indicated, we reached a point in our resource planning where a lot of the new data center growth is going to have to be served with new generation primarily. And so there's going to be a kind of different relationship between the CapEx and the megawatts associated with that load, but we'll provide updates on that information in the third quarter call in early November as we continue to make progress with the data centers and then finalize the resource plan to be able to support that.
...
Yes, I think that's fair, Paul. We've been working collaboratively with both the PSCW staff as well as the intervenors. They are scheduled to produce their testimony by August 12 next week. And so usually, historically, we've been able to start settlement discussions. And if we were able to reach any settlement discussions, it would likely happen before the hearing date, which is scheduled for September 9 at this point. So think about it over the next month; we'll have more clarity as to whether or not we will reach any type of settlement with the interested stakeholders.
...
Congratulations on a strong quarter. I have a housekeeping question and perhaps a deeper inquiry. I'm curious about your financing slide, where you mention an equity ratio range of 40% to 45%. What factors influence whether you fall at the lower or higher end of that range? Is it based on valuation or potential CapEx opportunities? I would appreciate any insights you can provide on that.
...
Great. I believe this is the final earnings call of this cycle. We've experienced a lot of updates, and this sector has likely never been busier. There are opportunities in capital expenditures, data centers, and more. When examining other companies and your pipeline, they all appear to be very solid. How should investors evaluate this, considering that every utility has provided us with mature opportunities? How should we compare your mature opportunities to those of other companies in terms of valuation and realization?

**Lisa M. Barton** *(President and CEO)*:

Yes. That is a great question, Anthony. And there are so many pipeline projects out there, and these numbers, after a while, when you think about it, there can be double counting even within a utility that we would know about, but certainly between utilities. And so we're trying to really avoid that for our investors. So when we talk about mature opportunities, these are very mature. These are ones where there are active discussions where we as a company feel that we have a very high level of confidence in being able to close these deals. I think the right question for investors to ask of all of us is really what is that threshold? And I would say for us, it's about an 85%, 85% probability that these are going to close.

**Operator** *(Operator)*:

Your next question is from Nicholas Campanella from Barclays.
