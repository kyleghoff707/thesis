...
Good day, ladies and gentlemen. Thank you for standing by. Welcome to the VICI Properties' Third Quarter 2025 Earnings Conference Call. Please note this conference call is being recorded today, October 31, 2025. I will now turn the call over to Samantha Gallagher, General Counsel with VICI Properties.
...
John, I was hoping you could talk about some of the more non-gaming conversations you're having these days, and your feelings on potential likelihood of getting deals done. And I'm especially interested if you could touch on collegiate or university level athletic facilities.

**John W. Payne** *(President & COO)*:

Everyone is smiling around the room because I have spent significant time with experiential operators and in university sports, which is a particularly interesting area. University sports, in my view, are undergoing significant changes. When I speak with athletic directors, CFOs, or chancellors, they often agree that these changes are indeed occurring. We have engaged in extensive discussions about sports infrastructure. Various investment firms are becoming involved in professional and collegiate sports, but VICI presents a unique approach in how we can support the growth of infrastructure and facilities, such as arenas, stadiums, practice venues, and ice rinks. This has been a valuable learning experience for both the universities and VICI on how our capital can be utilized effectively in this sector. Additionally, gaming continues to be our primary focus, and we are actively engaging with both current and new tenants. We are also exploring other experiential operators in mixed-use developments, attractions, and certain resort properties. University sports represent a significant opportunity; every university we have met with is working on projects that require funding, and they are determining how to finance these initiatives in the current environment.
...
Regarding Clairvest, as you mentioned, they have experience with gaming assets in the U.S. and Canada. Do you anticipate doing more deals with them? Do you believe they are actively trying to grow their presence in the U.S., or is this more of a unique opportunity for them?
...
Okay. I wanted to ask about the loan book. Are any of the borrowers experiencing short-term difficulties? Is everyone current on their payments, especially considering some of the softness we're observing in the broader economy, particularly in certain types of venues?
...
I appreciate all the candor, as usual. I wanted to just go back on the sports facilities commentary, John. Not have you negotiate something in this kind of forum. But just out of curiosity, are there any historical cap rate or any kinds of comps or anything like that? Just out of curiosity, how we would think about the opportunity if people like us wanted to sit down and try and develop the TAM and think about what it all means for you?

**Edward Pitoniak** *(CEO)*:

Yes, I'll begin, David. If you're looking for a historical example of private capital entering real estate on university land, the development of on-campus student housing by private capital is a good comparison. American Campus Communities, which is a REIT, exemplifies this as they previously did just that. We needed to ensure they were achieving a positive spread between their average cost of capital and the cap rate they agreed upon for the campus. The landscape of sports infrastructure and college campuses is rapidly changing in a market that is extremely volatile, and everyone is trying to adapt quickly. However, what John and the team are discovering is that the concept of conventional private equity investing on campus with a 5- to 7-year investment horizon is not particularly attractive.

**John W. Payne** *(President & COO)*:

Yes, David, it's great to hear from you. I know you've inquired about this sector previously. It's crucial to recognize that our company is enthusiastic about identifying a space where we see significant opportunities to invest. We've been focusing on understanding the landscape, identifying the key decision-makers, and gauging the extent of the opportunity. At the same time, we have been listening to universities about how they could utilize our type of investment. Currently, we're in the midst of these discussions. It's evident that state-run schools differ from private institutions. Therefore, we are continuously refining our perspective on the opportunities available. We are also discussing pricing. As Ed mentioned, there are alternative sources of external capital that are engaging with universities. As I initially pointed out, there's considerable change occurring in collegiate sports at this moment, presenting us with a chance to invest because we believe there is substantial capital to be deployed.
...
So with Six Flags in the news recently, I thought that presents a good opportunity to ask about your broad level of interest in theme park real estate ownership. The pros and cons that might come with those types of assets. And related to that, I'm curious if you've explored the theme park landscape internationally as well as domestically in the U.S.
...
Yes. And I'm going to ask Gabe to chime in here in a moment. Chris, but one of the things we always do when we look at any particular experiential category is work to determine the degree to which there's a meaningful amount of real property within the business that is ready. And Gabe, you can opine if you wish on theme parks and other categories we looked at, ski resorts and other things.
...
Yes. There are obviously contractual considerations, and I'm looking at Samantha to help if we need to clarify any of those. However, the main point to start with, Chris, is the economic significance of the assay. What rent could it support at a coverage level we are all comfortable with? That is the starting point. What is the EBITDA before rent of the asset? And what would be a level of rent coverage that both we and they would be comfortable with?
...
And, Ed, thanks for the comment on Viktor's piece. His reports are absolutely a must read in. He's another person that probably reads multiples of most of us on the call here. So, maybe just wanted to start with the call right on the Caesars Forum Convention Center. We've kind of eclipsed that time period where that begins. It seems like all the commentary from Vegas operators is that conventions, the group pace, the outlook, you talked about some of the citywides is extremely positive. It's obviously some of the leisure concerns that have hurt some of the near-term results. So, with that opportunity for that call right, how are you guys thinking about timing on that versus other deals?

**John W. Payne** *(President & COO)*:

It's a very good question, and I appreciate your comments about Las Vegas. You mentioned near-term concerns regarding leisure customers. In my opening remarks, I pointed out that we often focus too much on the short-term and fail to recognize what a fantastic destination Las Vegas is and will continue to be. We evaluate a variety of aspects, and you are correct that the opportunity to acquire the Caesars Forum Convention Center is currently available. We're considering the right timing for this opportunity alongside other factors. As I mentioned earlier, we strongly believe in Las Vegas and will keep investing there over time.

**Edward Pitoniak** *(CEO)*:

Yes. I just want to jump in and emphasize, Chad, along the same line. The degree to which Vegas is competitive dominance across the American convention trade show and conference space has only increased in the last 5 to 10 years. If you look across the competitive landscape of the big American convention centers in the gateway cities, it's actually kind of a sad story. First of all, most of the full-service urban hotel products have seen tremendous underinvestment. And a lot of the convention facilities themselves are in need of substantial capital and/or infrastructure. It would have been, for example, here in New York, it would've been a very positive thing for the Javits Center if the related wind project has gone ahead and created hotel inventory adjacent to Javits. But as we all know, that project didn't happen. And as a result, Javits is still this conference center, the convention center near pretty much nothing in terms of hospitality infrastructure. And that's just one example among many across the U.S. where Vegas, again, just shines because of the amount of capital put into both the conference convention and trade show facilities, $100 million in the Mandalay Bay. Again, I can't remember exactly how much the Venetian put into the Expo Center. But at any rate, this competitive dominance is only going to grow in the years ahead.

**Chad Beynon** *(Analyst)*:

That's great. And then moving over to the tribal lending landscape. I know we talked about before the North Fork loan is very different than a traditional loan to a tribe. But how has that evolved? And how is your comfort level working with other tribes evolved here?

**David Kieske** *(CFO)*:

Yes, Chad, it's David. Good to hear from you. To clarify, North Fork is a loan to a tribe and follows a standard lending structure. What sets it apart is that there’s no security in real estate, which is typical in tribal gaming. We have strong relationships with tribes on commercial land, and particularly with Red Rock, as we develop what will be an exceptional asset in Madera, California, set to open in around Q3 2026. We are also in discussions with other tribes. Any projects involving tribes must be supported by a strong team and a valuable asset, but ultimately, it will be a credit investment. There’s no way to possess gaming real estate on tribal land with security in that asset. Our active credit portfolio is led by Gabe, who you’ve heard from on this call, and we will keep looking for opportunities to smartly invest capital with reputable tribes as they come up.
...
Your initial question was about the negotiations, and we are really excited to have Clairvest as one of our tenants, hoping to continue growing with them. They operate assets that we own. Regarding the increase in opportunities, we're actively exploring many sectors within gaming and experiential markets, and there are numerous deals we're considering. I do hope there will be more deals in gaming, and we will engage with operators and potential sellers. Colin, I wish John was here; I had something nice to say about him, and it’s unfortunate he’s not on the call. Please pass along my regards.

**Unknown Analyst** *(Analyst)*:

He's going to be very disappointed. I didn't hear that, but definitely...

**John W. Payne** *(President & COO)*:

You're not going to get a repeat next quarter. So he's one and done.

**Edward Pitoniak** *(CEO)*:

Yes. If you're going to be here, turn next time, Colin.
...
I would say, as the Spanish like to say with tranquility, if it goes lower, that's perfectly fine. If it goes a little higher, that's also fine. But as you remember from our dinner in Boston, leverage is important to us, just like laddering. What we appreciate about the 5x debt-to-EBITDA benchmark is that it equates to having $1 of debt for every $0.20 of EBITDA. I won’t go through the math I explained at that dinner, but as you and your clients noted, we like the approach of laddering where roughly no more than 10% of debt is due in any given year. This aligns with the 5x debt-to-EBITDA, so in a worst-case scenario where the credit market closes, we could, if needed, pay off expiring debt with available cash flow after debt service. So, around 5x, plus or minus 1/10 here and there, we don't focus too much on precision. It's more about building a ladder for the future while optimizing the retained cash flow we generate, which, as we've mentioned before, is now in the $600 million range. This gives us the capability to achieve the kind of year we're experiencing, where we're again growing AFFO per share this quarter by 5.3% while our share count has only increased by a little over 1%.
...
You all own a lot of properties on the Las Vegas Strip, but not all of them. Based on your experience, what kind of macro or Las Vegas demand environment do properties typically come to market there? And if the opportunity rose, would you expand your ownership on the Strip?

**John W. Payne** *(President & COO)*:

I'll address the last part of your question. For the right property and operator, we would definitely consider expanding our presence not just on the Las Vegas Strip and in the local market I mentioned, but throughout Nevada as well. However, predicting when properties will come to market is quite difficult. It largely depends on the companies and their strategies regarding the proceeds from their real estate monetization. I want to assure you that, in line with Ed's comments, we will be ready if an opportunity arises for an asset on the Las Vegas Strip. However, I cannot specify when these opportunities will occur.
...
That's great. And then just one quick related question. With most of those opportunities, I know it's very premature, but would they be leasehold interests because you presume the university continue to own the underlying land, or is that not necessarily?
...
Our final question today will come from Alec Feygin from Baird.
