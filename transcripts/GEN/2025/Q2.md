...
The national data breach certainly raised awareness about risks. This quarter, we expanded our customer base across all brands and continents, particularly in the Americas and Europe. We noticed a significant increase, especially in identity protection in the US. Currently, we estimate that roughly one in three Americans has enough personal data exposed on the dark web for criminals to create a profile and conduct identity theft. It’s essential that we continue to raise awareness so that everyone understands these risks. It’s similar to insurance; a major incident often prompts the need for protection.
...
Thank you for the question. This is Natalie. We definitely observed an increase in our cross-sell penetration, which has been a key growth driver for several consecutive quarters. We outlined this as one of the essential levers for achieving sustainable accelerated growth in the mid-single digits. It's important for us to share our starting point and the milestones necessary to achieve this growth rate in the long term. While we won't provide a specific metric each quarter, we expect consistent performance that contributes not only to our bookings growth but also to our average revenue per user from cross-sell. Regarding the LifeLock attach rate, as you've likely noticed, our LifeLock customers are very valuable and retain well. This quarter has been particularly positive for our business, with increased LifeLock acquisitions and more customers upgrading to higher membership tiers, driven partly by the recent NPD breach and heightened market demand.
...
Yeah. I would say it's going to be a consistent approach that we've taken for the last handful of quarters. Of course, we all know what's happening in the debt market, and the cost of debt now is very different than the environment we were in a year ago. But both are very important for us in terms of capital allocation strategy. We'll strike the right balance quarter in, quarter out—not a specific percentage because we flex based on the macroeconomic indicators. So, everything from the cost of debt to the timing of the cash, Q2 is our highest use of cash, so we were largely constricted in terms of what else we could do for additional capital allocation, but we also know we're highly, highly cash generators. So, the back half of capital allocation would be very balanced and very interesting.

**Ryan Powderly** *(Analyst)*:

Got it. That's super helpful. For my follow-up, I would like to explore another aspect of net adds that caught my attention. Can you discuss first-year retention and its trends? We mentioned this during Analyst Day, so I'm curious if there have been any improvements and how that's been evolving.
...
Yeah, it will be all of our lever, but let me explain, right. So definitely, we can see a very strong rise in scam, personalized scams and volume personalized scams through the use of AI. And when we came out with Genie, we were singly focused on really developing our LLMs to be able to spot those scams and then help our consumers detect what is a scam and what is not. And we did that also with a conversational interface, you can also decide on what's the next step with the scam. We've had 1.6 million downloads, very strong models and I think we're now ready to move that into our overall portfolio. We'll start first with the Norton 360 membership being the core Genie assistant or the anti-scam assistant in the first three levels of our Norton 360 plan. And then we'll ramp up in features moving from tech scams to voice scams to call blocks to scam insurance through the different plans, if you want, all the way to Norton 360 with LifeLock. So that's coming now. The first path of monetization is to help our customers to move and upgrade to the next level of plan that not only provides the current features of safety but extend to all of those I've just mentioned. And there will be a Genie Pro cross-sell, if you want for those who want to stay tied to their old plan and just want to have a standalone anti-scam tool.
...
Absolutely. So the pricing is kind of an enterprise agreement, but it's on a per-proceed basis. It either is fully sponsored or partially sponsored by the employer benefit plans, and the pricing is slightly below, but not materially below what you charge from the consumers.
...
Hey, this is Natalie. I'll address that. Most of our sequential net customer additions have been driven by our expansion of mobile solutions and our growth in international markets. Both factors have consistently contributed to our customer acquisition efforts as we enhance our value for mobile users. This trend continued in Q2. Additionally, we observed increased demand for our identity offerings. Moving forward, it's crucial for us to maintain a strong focus on healthy customer acquisition on a global scale across all our brands and platforms. We will keep expanding internationally as we find new markets for customer acquisition. We're just beginning to enhance the value and engagement we offer to our growing base of mobile users and customers. Furthermore, we will continue to support all the brands within our portfolio since each one is important. Going forward, we will balance our investments in product development and technology solutions along with our various marketing channels to optimize our healthy customer acquisition, which in turn drives our increased ARPU, cross-sell opportunities, upsell efforts, and overall growth in retention and bookings.
...
It's not significant for us. When we adjust our guidance, we simply use the current currency rates available to us and do not forecast any currency changes.
...
Hey. It was a solid quarter with a strong record of net additions. I want to ask about the cost side. The EBIT margin appears to be slightly higher than in recent quarters. Can you share what you are currently seeing regarding advertising costs? I know they have fluctuated in the past.

**Natalie Derse** *(CFO)*:

It varies across all the brands and different channels. We have a diverse set of channels, and our marketing spend in those areas is increasing. You're referring to the gross margin rates, and we do notice shifts in our marketing portfolio. We focus on achieving a healthy return on investment for customer acquisition and make use of the diversification in our channels. There are different accounting treatments depending on the marketing channels, so it's important to factor that in when considering gross margin, operating margin, and EBITDA margin. This understanding helps explain why we can maintain a consistent operating margin quarter-over-quarter, as it relates to the P&L profile of the marketing channel expenses for this quarter.
...
Hey, it's Dan Bergstrom for Matt Hedberg. Thanks for taking our questions. Natalie, you just mentioned accelerated bookings growth in your answer to one of the last questions. That 5% constant currency number, really nice to see, especially following the uptick to 4% last quarter. And then it looks like the key assumptions moved up to 4% to 5% from 3% to 5% last quarter. Maybe just what could that 5% portend for revenue growth over the next year? Should we think of maybe the difference between bookings and revenue growth that's narrowing or maybe solidifying the potential around revenue acceleration? Just any further thoughts around the accelerating bookings growth here.

**Natalie Derse** *(CFO)*:

The majority of our portfolio is predictable in nature. Therefore, it will be gradually removed from the balance sheet in a consistent manner. We don't experience much seasonality in the size of our quarterly results. Overall, it will phase out over the next 12 months. While we have some monthly subscribers, which account for a smaller portion of our business, those figures will be reflected in both bookings and revenue during the same period since we recognize revenue as we provide the service monthly. Generally, most of our portfolio operates on an annual subscription basis, and a significant portion will be recognized over the next four quarters.
...
That concludes our Q&A session. I would now like to pass the conference to Vincent Pilette, CEO of Gen Digital Inc., for closing remarks.
