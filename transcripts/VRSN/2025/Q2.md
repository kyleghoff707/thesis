...
- **D. James Bidzos** — Executive Chairman, President and CEO
- **John D. Calys** — Executive Vice President and CFO
...
Okay. Well, first of all, the things that we mentioned earlier are the main drivers. Number one is a refocus on new customer acquisition by registrars versus the ARPU that we saw for a period of time. So that cyclical turn is a tailwind that we were anticipating and hoping; we didn't know exactly when it would come, but that's certainly here. And then registrar engagement with our marketing programs seems to be accelerating the improving trends in demand for our domain names. And we'll continue to refine and improve the programs as we learn and monitor their performance and apply what we learn, and hopefully improve their effectiveness. And I know this is on a lot of folks' minds. So I'll just say, as a reminder, the cost of our marketing programs is baked into all of the updated guidance that we provided today. And all of these programs are accretive. And I would just call out the improvement in the preliminary renewal rate of 75.5%, up from last year's Q2 rate of 72.7%. I think that's significant. The midpoint of the DNB guidance that we gave today reflects what we expect to be a continuation of the trends. We think it's prudent not to ignore the variables here, so there's a little bit of caution baked in there as well. We'll certainly update you next quarter. But I'd say to sum it up, we're pretty pleased with the improvements that we're seeing. We're going to keep doing what we're doing with the programs and improve them, help accelerate the trends that we're seeing now across all the regions.
...
I believe you are referring to the latter aspect. As I noted last quarter, earlier this year, two registrars promoted themselves during the Super Bowl. While that’s a rather extreme example, we observe similar activities where they are concentrating on attracting new customers. We believe our programs are aiding and speeding up this process, creating some synergy between the two. Additionally, the diverse channel we mentioned operates under various business models. By providing a range of programs that allow all participants to engage, we receive a lot of positive feedback. We regularly visit our channel partners to communicate with them. I would say that not only are we gaining insights, but the feedback we receive is significantly shaping our upcoming programs for 2026.
...
I have a couple more questions, if you don't mind. First, I’d like a quick update on the new domain auctions coming up later this year, along with your thoughts on expanding beyond .com, .net, and possibly .web. Also, I'd like to discuss the broader implications of generative AI and the trends affecting the open Internet, as this is a frequent topic in conversations with investors. Specifically, I’m interested in how you see these developments impacting the mid and long-tail of the Internet over time, including changes in traffic to the open Internet and how this could influence the growth and significance of domains and websites. Given your position, I would appreciate your insights on this.

**D. James Bidzos** *(Executive Chairman, President and CEO)*:

Thank you, Ygal. You raised several good questions, and I'll do my best to address them briefly. First, I believe you were mentioning the new gTLD program that ICANN is set to launch next year, with the goal of opening the new application window in the second quarter. We're looking into this, and we have been actively involved in various aspects of the program. Regarding auctions, it seems that there will likely not be any, and instead, another mechanism will be implemented to resolve cases where multiple applicants apply for the same TLD. We are exploring any potential opportunities that might arise from this, but it's too early to provide specifics.  You asked about .web, and there is an update on that front. Recently, we were granted permission to participate in the IRP arbitration panel. We've submitted our briefs, and the plaintiff, Altanovo, submitted theirs in June. Our responses, along with ICANN's, are due shortly, and the final hearing is scheduled for mid-November 2025. We remain committed to becoming the registry operator for .web and to delivering this TLD to our customers as soon as possible. We believe Altanovo is misusing ICANN's processes to delay .web's market entry, acting in bad faith. On the topic of AI, there has been significant interest, and we view it positively. AI can enhance domain names in two primary ways. First, AI models generate their data from websites, and we anticipate that AI optimization will play a crucial role in developing more content-rich sites. There is no static data today; all information evolves, and it is essential to navigate the internet effectively, which is where our infrastructure is vital. Secondly, AI tools can be highly effective in suggesting domain names. Over time, we've realized that multiple keyword .com domains are valuable, and we are incorporating this knowledge into our suggestion tools. Internally, we are taking a very cautious approach to our use of AI in our infrastructure, focusing on security and stability while avoiding unknown risks and single points of failure. We are being very careful as we define our AI usage and proceeding with great caution. There's a lot to cover here, and I hope I addressed your questions adequately.
