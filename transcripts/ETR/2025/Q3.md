...
Hello, everyone. My name is Greg, and I will be your conference operator today. At this time, I would like to welcome everyone to today's Entergy Corporation Third Quarter Earnings Call and Teleconference. I will now turn the call over to Liz Hunter, Vice President of Investor Relations for Entergy Corporation. Liz?
...
It looks like our first question today comes from Shar Pourreza with Wells Fargo.

**Constantine Lednev** *(Analyst)*:

It's actually Constantine here for Shar. Congrats on a great quarter. Maybe starting off on the updated CapEx plan and kind of the 4.5 gigawatts of the power island equipment. Is that directly associated with some of the more visible load in the current pipeline? Do you anticipate any incremental CapEx needs that would require regulatory approval before making it into the '29 plan? Just how should we be thinking about the upside here?

**Kimberly Fontan** *(CFO)*:

Constantine, it's Kimberly. The $41 billion includes the capital that's needed to support the load that is in the forecast. The 4.5 incremental gigawatts that Drew referenced would support additional customers that could come online. So we referenced 7 to 12 gigawatts in the data center. That's up from 5 to 10 in the last quarter. We've added, as you noted, additional plant power island equipment in order to support that. To the extent that those customers in that pipeline reach agreement, we would expect that you would need supplemental capital to support that, and that's what we plan ahead for here.
...
As you know, we added 2029 here. There’s certainly good visibility through that period. If we’re able to land additional customers, we’ll provide you that visibility. However, beyond that, we believe we have long-term opportunities that extend past this period.

**Constantine Lednev** *(Analyst)*:

Okay. Perfect. And just a quick follow-up on kind of the generation needs, kind of more broadly. Do you see customers agnostic to the resource mix? Or is there still a push for some renewable components as we've kind of seen with hyperscalers demanding for nuclear SMRs and other technologies?

**Kimberly Fontan** *(CFO)*:

We talk to our customers about all kinds of supply. Certainly, we've lined up here. Drew referenced both gas resources as well as renewable resources. We do have a pipeline of opportunity around renewables based on customer needs, but we also continue to look for ways to meet their needs to ensure that we are speed to market as well as meeting clean needs. So we think it's an all-of-the-above approach over time.

**Andrew Marsh** *(Chair and CEO)*:

Yes, and Constantine, I'll just add that we are building this gas generation, but we have expectations that we will also do carbon capture at some point, and we are working on that actively. We have RFPs out in for some of our assets in Mississippi and in Texas to test that. We still have FEED studies going on at our Lake Charles Power Station in Louisiana. We're exploring various options to figure that out. We're supported by our data center customers that are wanting to achieve those same objectives. So we think we're well positioned to figure that out over time, but we don't have anything specific to announce today.

**Jeremy Tonet** *(Analyst)*:

I wanted to expand a bit more on the future outlook. Some of the comments may have pointed out the capital moving closer to plant commercial operation dates, which might extend beyond the planned period. I'm curious if you could discuss the ongoing momentum across the plan and how it appears after the planned period, especially since you've mentioned in the past that this will accelerate towards the end of the decade.

**Kimberly Fontan** *(CFO)*:

Jeremy, it's Kimberly. I guess just to clarify, $41 billion through 2029, I referenced some plants that close outside the period. Some of that is alternate financing. So you don't see the spend in this period and all the spend would go out when that closes. So that was that reference there. But certainly, with the additional equipment that we've secured in the pipeline that we see, we would expect investment to continue well beyond this period.

**Andrew Marsh** *(Chair and CEO)*:

Yes, and we do have turbine slots that are delivering for commercial operations in '29, '30 that still have not been announced as overall projects. There are still opportunities that could add additional capital in the out parts of our current outlook period.
...
Yes, people are excited in Arkansas about that project. At Google's groundbreaking last month, the governor and many local leaders, including the Mayor of West Memphis, were present. There is also a 600-megawatt solar facility and a 350-megawatt battery that will support Google. This investment is currently being reviewed by the Arkansas Commission as well. We expect to navigate that process with the various stakeholders. At this point, there is significant support in Arkansas for the economic development this opportunity will bring.

**Jeremy Tonet** *(Analyst)*:

Got it. And maybe just taking a step back overall, I guess, commercial discussions here with hyperscalers. At this point, I guess, how would you describe the tone or pace of discussions here? Is there more or less urgency to sign up incremental load at this point given the success that you've had so far?

**Kimberly Fontan** *(CFO)*:

Well, certainly, I would point to the raise from 5 to 10 to 7 to 12 gigawatts around our increased customer conversations. Those conversations cover all the things that we've talked about before, speed to market, getting to client, and also how the stakeholders and bringing the stakeholders along. As Drew said, in Arkansas, very excited about that transaction in Arkansas. We think the conversations continue to be strong and continue to support our incremental increase in that pipeline.

**Jeremy Tonet** *(Analyst)*:

Got it. One last quick one, if I could, on the transmission side. Just given some of the load shed events due to storm activity earlier in the year, wondering how you think about the opportunity to deploy more transmission, enhance flexibility, such as increasing connectivity into Mississippi. Just wondering how you see the opportunity set at this point.

**Andrew Marsh** *(Chair and CEO)*:

Yes, we do still see a robust transmission opportunity, but it will be customer-driven based on how the grid needs to adapt to continued growth in our service territory. Right now, we have a very robust over 400 miles of 500 kV line. We have a lot of 230 kV transmission that we are also building. We're getting ready to file in Louisiana, the Babel to Webre line. I think I talked about that last quarter, which is part of that 500 kV system, and we have approvals pending in Texas and in Louisiana on transmission right now. So there is the possibility for significantly more. We have quite a bit coming through the MTEP process that's seeking MISO approval by the end of this year. Depending on the growth, there could be additional investment opportunities out there. So we are expecting continued significant transmission investment going forward.
...
The timing for the extra 6 units would support commercial operations in 2031 and 2032. We're using our standard design of 750 megawatts, which totals a little over 4 gigawatts. That's the plan. I can't remember the last part of your question, David, remind me.

**David Arcaro** *(Analyst)*:

Yes. Curious if this is a stepping stone. Are you still actively in discussions and working to increase your access to gas turbine supply beyond that 4.5.

**Andrew Marsh** *(Chair and CEO)*:

Right now, it matches what we see as our customer needs. If there continues to be growth, then we may continue to go into the market and seek additional turbine access. But I think that's where I would put it right now. It's meeting our expectations of potential growth that we see in the near term. We're also looking at a number of other things. We continue to monitor new nuclear and look into that and talk to our customers about that. We are also looking at a number of upgrades on our system to provide incremental supply. Several things are out there that could still drive incremental generation capacity even beyond just gas turbines. Thank you for that question. We're excited to see some investment happening. The industry really needs to manage construction risk effectively. We commend the efforts that Brookfield, Westinghouse, and Cameco are making with the Federal government to address this. There are still many details to be clarified, and we look forward to discussing their initiatives further. We're pleased to see progress and the potential it has to advance the industry. Additionally, there is significant interest from our stakeholders in introducing new nuclear energy in Texas, Louisiana, Mississippi, and Arkansas. Each of these states has commissions or task forces exploring this, and we are actively involved in all of them. We continue to investigate these opportunities.

**Agnieszka Storozynski** *(Analyst)*:

So I was just wondering, we've all read about the Manhattan-sized data center in your Louisiana service territory from Meta. So how much of that is currently covered by ESAs and reflected in your pipeline?

**Andrew Marsh** *(Chair and CEO)*:

Right now, the only thing that we have in our outlook is the signed ESA that we previously announced about a year ago almost now. That project has been publicly said by Meta to be 2 gigawatts of compute. Any beyond that is not currently reflected in our outlooks. We wouldn't comment on any specifics of the size or timing of any project, just like for that potential opportunity, even though we know that they've been posting about it. But we wouldn't comment on it consistent with our ongoing policy for not commenting on specific customer opportunities.

**Sophie Karp** *(Analyst)*:

A couple of questions for me. On the regulatory front, given all of the demand from large customers and all the trends that we know about, do you envision that you will need something more beyond your regular formula rate plan proceedings to accommodate that growth and recovery, of course?

**Andrew Marsh** *(Chair and CEO)*:

Yes, it varies by jurisdiction. Thank you for that clarification. In Mississippi, there is a law that supports significant economic development projects by allowing them to proceed with a presumption of the certificate of convenience and necessity. However, we still need to obtain regulatory approval for formula rate plans and similar matters in Mississippi. The commission is still involved, but we can advance projects there. Louisiana and Arkansas have also made progress. Kentucky recently enacted the Generating Arkansas Jobs Act, which provides an expedited process. We are continuing our efforts in Arkansas, and we anticipate similar progress in Louisiana. We plan to utilize the same procedures in Louisiana, Arkansas, and Mississippi for large economic development projects.

**Sophie Karp** *(Analyst)*:

Got it. Got it. And then my other question was the 12-gigawatt pipeline. Could you help us and break it down by, I guess, the stage it's in, like how much of that is in the ESA stage versus the slightly earlier maybe in the process?
...
I had a clarifying question following up on David's a little bit. Could you explain the comment on the 8 gigawatts for additional growth from the power commitments above the plan? Because I recall it was 7 gigawatts from the second quarter call, and I know you said you added 4.5 gigawatts. But does that mean you execute against some of that incremental opportunity? I was just a little confused on that piece, if you could clarify.

**Kimberly Fontan** *(CFO)*:

Sure, Paul. I would think about in the second quarter call, we said 15 gigawatts, 8 was in the forecast through '28, and 7 was for growth. We now have 19.5 gigawatts compared to that 15, and 8 is for growth. So that delta is what I was referencing earlier around it's either in the forecast or it's in the forecast, but the capital closes outside the period.

**Andrew Marsh** *(Chair and CEO)*:

Yes, I think we would expect that there would be additional renewables associated with large hyperscaler deployment. We've certainly seen that with each of our announcements thus far. AWS had, I think, 600 megawatts of solar associated with Google similarly.
...
Yes, the 4.5 would be additional to what is shown on that page. There are other projects included in our total of 19 gigawatts that are not listed there, but the 4.5 would be an addition to what's already presented.

**Anthony Crowdell** *(Analyst)*:

Great. I think you mentioned in your prepared remarks about the availability of EPC. It appears there are no issues in obtaining craft labor contracts for constructing all the generation facilities. If you could provide any insights on this, especially since we've observed other large projects facing challenges with their size. However, it seems there are no labor issues. I would appreciate any additional information you could share on this topic.

**Andrew Marsh** *(Chair and CEO)*:

I would say that there are real challenges with labor. It's not easy to get the labor lined up. There is a real need for skilled craft of all types, and that hasn't changed. The result has been that there are increasing costs associated with these combined cycle projects. It's very real. Our projects aren't immune to that, but we're working through it with the EPCs.
...
To manage transmission costs, we are constructing generation facilities close to where our customers are located. While this may not be on-site or behind the meter, it is very nearby. An example of this is the Meta project. From a physical grid perspective, there isn't much difference. These customers have the ability to generate their own power but prefer to invest their capital elsewhere. This is evident in Meta's recent financing of their facility, where they are leasing it back in North Louisiana. They have capital needs and would rather not invest in generating stations. We are competitively positioned to support their growth by building our plants nearby, achieving similar benefits, and ensuring capital is deployed on our books instead of their balance sheet. I can't provide an update today as the team is still working on the case, and I don't want to get ahead of them. However, in Arkansas, over time, you will see similar benefits to those in other areas, where the advantages from a large new customer will assist existing customers. We expect to detail this in the upcoming rate case. Additionally, we are currently engaged in discussions about the existing processes concerning the formula and the special rate contract we submitted in Arkansas for Google.

**Alexis Kania** *(Analyst)*:

Just maybe trying to tie around this 4.5 gigawatts of incremental. I was just wondering if you could maybe tie that with the comments made a little bit earlier on the ERAS queue as well. Is that 4.5 gigawatts, does that tie to those extra incremental, I feel like 4 projects in the queue? More broadly, if the ERAS process right now is working as intended and seemingly should be able to help for the forward needs?

**Andrew Marsh** *(Chair and CEO)*:

Yes, the 4.5 gigawatts, those extra 6 turbines are not yet represented in the ERAS queue. The things that are in the ERAS queue would be much more near term than those. Those projects that we have in the ERAS queue would be coming in much earlier than that. So hopefully, that answers your question.

**Stephen D’Ambrisi** *(Analyst)*:

Drew and Kimberly, just kind of again on some of this discussion around the dispatchable generation. Can you talk a little bit more about the alternative financing agreements that you guys are using? Can I extrapolate what that is, the sizing of that, if you've gone from 8 gigawatts that I think was committed in 2Q to now the implied 11 gigawatts in Q3? Does that 3 gigawatt increase basically what's being alternatively financed and falls outside of the plan? Just can you give a flavor of the timing around that and the magnitude? Because it seems like that would be a $6 billion to $7.5 billion of spend that could come in 30 or 31, which would look like it would drive an outsized amount of growth.

**Kimberly Fontan** *(CFO)*:

Steve, it's Kimberly. I wouldn't think of it as a direct correlation between that alternate financing and the 3 gigawatts that you referenced. First, we added an extra year, so you rolled forward to 2029. You can see the run rate of that is consistent with where we've been in each of the prior years before that. That's your biggest piece. There is some alternate financing. We talked about that actually in our Legend filing in Texas as a way to help with the overall cost, but also time that closing with when that asset goes into service and throws off cash. We haven't sized that. We'll have a little more visibility into that at EEI. I think your numbers are a bit outsized relative to what you have here, and I'd think more about the 2029 addition.

**Andrew Marsh** *(Chair and CEO)*:

Sorry, Steve, just to add to that, all of these projects that we are bringing on that we've contracted for with these turbines, we expect to achieve commercial operations by 2032. They're all coming pretty fast. You could see a number of them on that Page 14 that we were referencing earlier. A whole bunch more are coming in the next few years, beyond that, if everything comes together on the schedule that we've laid out with the turbine orders. Quite a bit of capital is just over the horizon from 2029 to support that potential build-out.
