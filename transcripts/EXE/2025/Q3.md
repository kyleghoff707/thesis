...
- **Colby Arnold** — Manager, Investor Relations
- **Domenic Dell'Osso** — CEO
- **Operator** — Operator
...
Yes, Nick, it's great to see the improvement in capital efficiency. This leads to my question about 2026. Is it accurate to say that the capital expenditures should remain relatively flat in 2026 compared to 2025? What are some of the factors to consider as you look at the softer guidance for next year?
...
I would like to ask a question about breakevens and refer back to your prepared comments. I believe you mentioned that the company-wide breakeven is now $2.75. Could you confirm if I heard that correctly? Additionally, could you remind us of the other key assumptions that contribute to that figure? Specifically, I'm curious whether that includes location costs and if there is a minimum return threshold factored into that number.
...
And our next question comes from the line of John Annis from Texas Capital.
...
I want to follow up on the Western Haynesville. I have a couple of questions for clarification. First, regarding the geological complexities you mentioned, what other aspects should we focus on? Also, are you considering expanding your position in that area, or do you feel satisfied with your current holdings?

**Josh Viets** *(CFO)*:

Yes, Scott, we feel really good about the position that we've built. I mean with 75,000 net acres, of course, the gross acre position is going to be a little bit larger than that. And so we think there's some opportunities to maybe kind of build up in and around that position, but nothing material. Again, given our overall inventory depth in the basin, we think this is about the right size for us going forward. And then to your comments on the geologic complexity, one of the things that we've observed through our data sets is there is quite a bit of structural complexity as you move across the play, especially as you move further west, you'll get some very steeply deeping beds that create some complexities in terms of how you drill wells, especially in the lateral section. And so we are very thoughtful about where we want it to be. We like the area that we've got; that it has much less structural complexity within it, which puts us in a position to simply execute at lower cost while delivering outsized production results.
