...
Got it. Got it. And Alan congrats on the retirement. Thank you.
...
Yes. I'm not going to give too much color on it, Tom, just because it is proprietary as we said in the prepared remarks. But suffice it to say, it's an ultra-high power laser. So you can imagine a larger indium phosphide chip and placed on a carrier. So it's between a chip and a module and that it's today the product that we're shipping is a chip on carrier with very high power and a unique technology that we've developed over the years and are now shipping. I would say pre-production volume with forecasts for more meaningful volume throughout calendar '25 and then real extremely high volume in calendar '26. So, feedback is very positive. The performance is very unique and the line width that we produce with the laser is superior to anything in the market. So, we're very excited to be working with a very leading-edge customer. And I think I'll just leave it at that.
...
Thank you. And Alan congratulations. We'll miss you.
...
I guess if you added that, Alan, maybe I'll sneak in. What's your expectations for mix as we progress through this year on EML versus SiPho?

**Alan Lowe** *(President and CEO)*:

From a chip standpoint, very little CW lasers for Sipho because of the strong demand in EMLs. From a consumption standpoint in our transceivers, the vast majority is CW lasers for silicon photonics, but we are designing EML based transceivers. There will probably be more late calendar year than anything before that. So the vast majority of our designs that are in production and about to enter production are silicon photonic based.

**Ruben Roy** *(Analyst)*:

Got it. Thanks for all that detail, Alan. Thanks.
...
Our next question comes from Ryan Koontz with Needham & Company. Your line is now open.
...
I don't believe it's cannibalizing as much as it is contributing to the coherent transmission in the market. The boom we're experiencing now with 400 gig and soon 800 gig ZRs is remarkable. We're investing in our factory to meet the demand from customers producing the ZR modules. Many of our components are essential for the ZR market, but we currently lack the capacity and are facing challenges due to supplier shortages. From our viewpoint, it's additive. We hold a strong position in traditional coherent technology and we're seeing an actual strengthening in very high-speed products, including modulators and tunable lasers, to cater to that market. Overall, new products are performing well, ZRs are thriving, and we need to invest more in our factories to satisfy the growing demands from both markets.
...
Sure. All right. Great, Alan. Thanks and congrats on the retirement.
...
Our next question comes from Karl Ackerman with BNP. Your line is now open.

**Karl Ackerman** *(Analyst)*:

Yes. Thank you. And Alan congrats on the next opportunity in front of you.
...
Thanks, guys, for taking the questions. And, Alan, we'll miss working with you. Congrats on retirement.
