...
Hello, everyone, and thank you for joining us today for the Duke Energy Third Quarter 2025 Earnings Call. My name is Sammy, and I'll be coordinating your call today. I would now like to hand over to our host, Abby Motsinger, the Vice President of Investor Relations, to begin. Please go ahead, Abby.
...
Absolutely. To start off, could you discuss the incremental capital you are considering? I understand it's still a range, but how do you see that being integrated over time? Is it something that will be consistent throughout the period, or does the final year of 2030 indicate a more significant increase compared to 2028 and 2029? For example, the increase from $87 billion by an additional $10 billion could be spread evenly across the forecast or could be more concentrated in that last year. You haven't provided all the details yet, but I'm interested in how you view the timeline of the data center ramp. Is it genuinely leaning towards that final year? Can you elaborate on that?
...
And I would add, Julien, it's a very dynamic environment out there. And you saw us raise from $83 billion to $87 billion earlier this year with the Brookfield deal in Florida. And then you're seeing our capital expand here because of what we're seeing in data center growth and economic development as well as our modernization that Brian mentioned. So we'll continue to evaluate and update as we move.
...
No, Julien, it's more than that, but it does include that. As we enter into more energy service agreements, that will prompt us to invest further in transmission and possibly generation as part of this five-year plan. We are also looking into local distribution company investments that could facilitate the new generation at our Piedmont Natural Gas Company. We are considering all those investments, along with the array of transmission and distribution investments we have yet to implement. We are assessing all these aspects, including customer affordability, as we work on finalizing our capital plan. That is why we did not present a single point estimate this time; we are still running our models and reviewing rate cases over time and how they might materialize.

**Harry Sideris** *(President and CEO)*:

Julien, we will provide more details in February, as we usually do, regarding the financing plan and its specifics.
...
Yes. Excellent. All righty, I will leave it there.
...
It's actually Alex on for Shar. So I just wanted to touch on the earnings outlook. So you've indicated you expect to be at the high end of the 5% to 7% starting in '28. Just sort of want to get a sense, is there any potential for that growth to begin ramping sooner? And if you can just remind us what drives the delta between the 5% to 7% EPS growth and that 8%, 8.5% rate base growth you have out there?

**Brian Savoy** *(Executive Vice President and CFO)*:

That's a great question, Alex. We are making incremental investments, expanding our capital plans, and signing up more customers. Each year, we aim for growth within the 5% to 7% range. However, 2028 represents a turning point as we increase our investments in Florida. We'll finalize the multiyear rate plan, and the transaction with Brookfield will close. We've discussed our plans to enhance capital in Florida during this timeframe. Additionally, many of the large-load customers we are currently signing are approaching the completion of their construction projects, which are expected to be finalized in the latter half of 2027. This ramp-up will start, but it hits a critical point in 2028 and continues to grow into the early 2030s. This trajectory gives us strong confidence that we will be in the upper half of the growth range in 2028. It's important to note that the growth is robust, and I would consider it a compound annual growth rate in the upper half for 2028 based on a 2025 starting point of 6.30%, rather than just annual growth.
...
We believe it is sustainable beyond that and see the prospects continuing. Therefore, we consider this a long-term opportunity for us.

**Alexander Calvert** *(Analyst)*:

Great. I understand. Regarding the funding, you still have a significant amount of equity available. You have made good deals in Tennessee and Florida that have been beneficial. Are there other opportunities for asset recycling, or should we expect to see equity and similar instruments in the future?
...
This is Brian, and I’ll address that. Considering the upper end of our growth range for early 2028, I believe it aligns with the capital range we mentioned, which is between $95 billion and $105 billion. It does not rely on us being at the high end, nor would it be significantly lower if we were at the low end. All these scenarios have been taken into account.
...
Could you remind me what the advanced pipeline looks like for large-load? And how much of that would you say is in advanced discussions that could be added to the 3 gigawatts of ESAs you signed this year?
...
Okay. So you don't want to discuss how many near-term advanced discussions could lead to agreements being signed over the next year or so?
...
Yes, it's a great question. We provided this range in previous quarters, which has guided how we funded the capital plan in the current five-year plan. The lower end of the range would be influenced by investments that have a quicker recovery. These investments require less equity over time compared to those with slower recovery, which might take longer to be integrated into the rider mechanism, potentially necessitating more balance sheet support. In the last update, we noted that 40% of the additional growth capital was funded with common equity or equity support. I would consider the faster recovery investments to be at the lower end and the slower recovery investments to be closer to 50%.
...
Yes. Just to wrap up, I want to leave you all with 3 items. Number one, we see a lot of momentum into the end of this year and into '26 and beyond. Two, our business is in the strongest position it has ever been. And finally, I am confident we are going to earn in the top half of our 5% to 7% range beginning in '28. But more importantly, our plan is durable well into the future. So again, thanks for joining us today, and thank you for your investment in Duke Energy. I hope everybody has a great day.
