...
- **Operator** — Operator
- **Stephen Hemsley** — CEO
- **Timothy Noel** — Segment CEO, UnitedHealthcare
- **Patrick Conway** — CEO, Optum
- **Wayne DeVeydt** — CFO
- **Joshua Raskin** — Analyst
- **Krista Nelson** — COO, Optum
- **Albert Rice** — Analyst
- **Sandeep Dadlani** — CEO, Optum Insight
- **Justin Lake** — Analyst
- **Stephen Baxter** — Analyst
- **Robert Hunter** — Segment CEO, UnitedHealthcare
...
- **Dan Schumacher** — President, UnitedHealthcare
- **Scott Fidel** — Analyst
...
Sure. Why don't we just start with Patrick and then finish with Chris?

**Patrick Conway** *(CEO, Optum)*:

That's great. So thanks, Josh, for the question. High level, the breakdown on revenue is as we described last quarter, 65% VBC, 15% care delivery fee-for-service, and 20% are payer, employer services. Within VBC, it's about two-thirds of our book of business serving UnitedHealthcare, the rest consisting of a diverse array of payers. Within growth potential as we close out this year, as you heard, we plan to close 2025 just under that 3% margin with VBC margins under 1%. And then we're taking the actions this year to set us up for 2026, and I'll let Krista cover that portion.

**Krista Nelson** *(COO, Optum)*:

Yes. Thanks for the question, Josh. So I think as we are pacing into 2026, we remain anchored and committed to the long-term potential of this business, the 6% to 8% margin that we outlined in the second quarter. And within that, our 5% commitment to our value-based care agenda. We continue to work a robust set of actions and opportunities with clear line of sight, and frankly, a lot of the ambition to the work ahead. Again, just remain optimistic on our positioning for the long term.
...
I think Bobby Hunter is best for this?

**Robert Hunter** *(Segment CEO, UnitedHealthcare)*:

Yes. Great. Thanks, Stephen. So I'll hit the membership item first. Tim mentioned in the prepared remarks approximately 1 million membership contraction for 2026 across MA. That does include both group and individual. Obviously, we've been pretty clear about the fact that we're exiting products impacting about 600,000 members. So think about that as kind of your first core element of how you build to that 1 million. I would say the balance of the bridge to the full million is pretty evenly split between the pressure inside of our group MA business as a result of taking a disciplined approach to pricing there and some dislocation that will exist in the group customers as a result of some other more aggressive competitor actions. The other kind of 50% of that bridge from the 600,000 to the 1 million representing a pretty even split across our individual MA business. Obviously, really early in AEP at this point, but that's kind of the way I see it from this distance. When you think about growth overall, I would expect 2026 to be probably more in line with the general progression and growth that we're seeing in 2025. That's largely a result of continued benefit cuts in the marketplace, continued plan closures, and some disruption in the broker community related to pretty broad commission changes. I absolutely believe in the long-term growth potential of MA, and I think we can grow above those levels as you step out further. Ultimately, right now, though, medical trend pressure is increasing the cost of health care and the funding cuts of the program are degrading choice, access, and value to the consumer. That's a real impact on the 35 million Medicare eligibles who rely on MA right now to make health care affordable. I still absolutely believe in the differentiated value proposition of MA but can I underscore the importance of stability in the program as we look to the longer-term growth rate and opportunity for MA. Thanks for the question.
...
Could you provide more details about Optum Health? I'm curious about the recent pullback and the shift in focus towards specific types of plans. A few years ago, I believed that value-based care could cater to most Medicare Advantage lives. Is there a total addressable market you have in mind? Considering the current market and your targeted areas, what portion of Medicare Advantage seems suitable for a successful value-based care model? Additionally, how much penetration has occurred in that space today?
...
Yes, absolutely. Kevin, thanks so much for the question. So as we mentioned in our opening remarks, we are deeply committed to value-based care and research continues to validate the impact that it can have. We know fee-for-service rewards volume. We know that value-based care aligns incentives. When you look across Optum Health, we've got an incredible set of assets that really enable an integrated delivery system to create value in the market that we are focused in. So I just think about the potential. It really is limitless. I think what you're seeing from us is a focus and operating discipline and really kind of getting back to some of our core so that we are able to expand and grow in the future. We're really deepening our presence in the markets. We're focused on the appropriate network, on the appropriate providers, on the appropriate risk, footprint portfolio so that we are positioned for long-term success inside value-based care.
...
We noticed a considerable increase in what I would refer to as discretionary expenses during the quarter compared to Q2. You mentioned the necessity for investment in several business lines. As you reflect on those figures, could you detail the increase in investments made in Q3? Additionally, how much of that should we consider as ongoing investments versus one-time expenditures that will yield benefits in the future?
...
I just had a question regarding utilization and how to think about it here in the back half of the year. Clearly, this quarter came in a little bit better than what we were expecting, but we're looking at what's happening with the exchanges, looking at the step-up in Part D. So can you maybe just talk about your expectation going into the fourth quarter? And specific to Part D, are you expecting a big step-up as we think about the fourth quarter?
...
Yes. Thanks, Lisa, for the question. As I think about utilization, it's really tracking in line with the expectations that we called out in last quarter's call, really across all of the product lines, the general commercial business, including the ACA as well as Medicare and Medicaid. On the Part D portion of the business, also tracking in line with expectations. Clearly, there is quite a bit of seasonality that's always at play in the health insurance business. I think you can think of normal seasonality, first half to second half as 60% in the first half in terms of earnings contribution, 40% in the second half. This year, given some of the trends that we've seen, a little bit more of a bias towards earnings in the first half of the year versus the second half of the year, but really trends tracking with how we expected them to track, consistent with what we guided in the second quarter and the seasonality really just kind of a byproduct of the business. Also some of the additional spend that we have on things like a seasonal ramp in AEP with respect to Medicare.
...
Could you talk a little bit about the employer market? And specifically, what's the medical cost trends you're seeing this year and next? And given the pressures on employers, what are some of the strategies they're looking at for '26 and looking out to '27 on the selling seasons, in particular, any interest in adoption of value-based care? Are they using more Surest, things like that?
...
I appreciate the update on the capital deployment timeline returning to the normal plan. Can you provide an update on the dividend and your outlook for it moving forward? Also, I understand there may need to be some portfolio adjustments in Optum Health and other areas as you adopt the new strategy. Can you frame that for us in terms of revenue or more generally, how you are approaching the asset base in Optum Health and the possible rationalizations that could take place?

**Stephen Hemsley** *(CEO)*:

Sure. The dividend, we'll start with Wayne and then I'll start with the Optum and give it to Krista and Patrick. So Wayne?

**Wayne DeVeydt** *(CFO)*:

Thanks, Steve. Scott, there are no changes in our historical dividend practices, nor do we expect those to change going forward. We will maintain the dividend as we've done. The next prioritization as we're paying down debt will then revert back to the buyback program and then our strategic acquisitions. So view it as no changes and then hopefully back into our normal capital deployment activities back half of next year.

**Stephen Hemsley** *(CEO)*:

And then just broadly, related to Optum Health, helping people understand, we are very much committed to this. We are just reshaping it back to the way we had originally conceived it and believe that it has the most impact on value and we're really just taking the right steps to bring that back into form so that we can really move and grow and advance it in the construct of that disciplined model we had going forward.

**Krista Nelson** *(COO, Optum)*:

Yes, I can just add to that. Thanks for the question. So yes. So Scott, as Steve mentioned, we are really taking a look at the whole integrated delivery system. We have a combination of value-based care assets, some assets that are focused more on fee-for-service, but truly enable that value-based care agenda. It's really important to ensure that kind of integrated model can deliver the best outcomes. As we're thinking about the portfolio rationalization, we are taking into account a combination of things like where we have the right clinical quality, where we have the best operating cost performance, where we have the right engagement, and where that model can really be brought to life for both value-based and those fee-for-service service lines as well. I think those are the ways in which we're looking at the model. So it's a market focus. We are looking at rooftops. We are again looking at the populations, the risk, the products, and I think through all of that, there will be an output of some actions that we'll take in the near term to position us for long-term success of that integrated model.

**Stephen Hemsley** *(CEO)*:

We are likely going to exit some geographic markets and will probably adjust our practices in the markets we continue to serve. We are aiming to align our primary delivery system with complementary services. All of these changes are logical and constructive, but to improve, we sometimes need to make difficult decisions.

**Patrick Conway** *(CEO, Optum)*:

In order to connect a couple of questions, I would like to emphasize that amidst rising cost trends, our payer partners, employers, patients, and providers are looking for a value-based care system that offers improved quality, a better experience, and lower healthcare costs. That's exactly what Optum is providing to our diverse clientele.
...
Yes. Yes, thanks for the question, Erin. So let me just kind of start where you ended, which is likely more back half weighted, but you should expect progress throughout here. While we might see faster progress in some fee-for-service improvement, Patrick highlighted whether that's kind of productivity or scheduling, improving access, or collection rate, you'll also start to see some progress on our value-based portfolio as well. So think of things like medical management, the work we're doing with our payers, the work we're doing to curate our network, also the work we're doing to manage operating cost discipline. So these things really all come together in this integrated model, but maybe some faster progress in certain areas while you'll still continue to see progress against the holistic model.

**Stephen Hemsley** *(CEO)*:

For instance, we are noticing some advancements in the Eastern region, which is a positive example of how this will develop.
...
Yes, absolutely. So yes, like Patrick mentioned, we sought to overcome half of the V28 headwind through our payer contracting efforts, which would include all payers. We have completed that, and we're about 90% complete with our contracting with line of sight to the rest by the end of the year. I feel good about that. That encompasses rates as well as product and benefits. We've talked a little about some market exits inside of that. Exiting more than 40% of our PPO footprint was also part of that exercise, but again, across all of our payers. You asked about membership as well with the approximately 10% reduction as we pace into next year. Again, we probably will see even some additional PPO exit as part of the work we continue to do with all of our payers and the work that we're going to do to finish that work, but that would really be a direct result of actions we're taking to optimize our portfolio. Products, market, footprint, and the risk that is appropriate for this model.
...
You can decide who wants to respond to that. We're not advocating for anything specific. So, please?

**Timothy Noel** *(Segment CEO, UnitedHealthcare)*:

Yes. Thanks, Jess, for the question. As I think about CMS receptivity, we've been encouraged and continue to be very encouraged by the receptivity of this administration to have conversations with industry about ways to modernize and ways to improve this already very popular program. This is in direct contrast to what we experienced over the previous administration. We've always enjoyed and appreciated the efforts to be able to have these fact-based conversations around how to modernize the program, and feel like that's the best way to get to constructive answer and a constructive way to move forward. We're encouraged again on just the level of activity and the level of conversation that we have with the administration, and we'll continue to do that and continue to bring to them ideas that we think are the best path forward that provides some level of stability for beneficiaries and also modernize the program in the process.
...
Thank you for the question, Whit. When I consider the trends we’re observing, a significant portion relates to increased service intensity per encounter billed by health systems and providers. This includes higher-cost service locations where lower-cost options exist, such as labs, emergency rooms, and surgeries. I’m also noticing a greater number of services associated with emergency room and hospital visits, an uptick in specialists involved during inpatient stays, and a tendency towards higher Diagnosis-Related Group (DRG) weighting than previously seen. While this trend is relatively consistent nationwide, there are notable outliers. We are addressing these outliers because it is essential to keep medical costs and healthcare affordable for consumers, states, and the federal government. Consequently, we will implement network actions as necessary to ensure affordability. Additionally, we are increasing our use of AI in payment integrity programs and enhancing payment policy efforts alongside clinical affordability programs to tackle some of these issues. Regarding the Independent Dispute Resolution (IDR) process, it does not appear to be a significant trend driver at this moment, but we are closely monitoring it.

**Stephen Hemsley** *(CEO)*:

Great. So thanks, great conversation today. That's all we really have time for. I want to thank you all for joining us, and we look forward to talking with you again and engaging with you before we get to January. In January, we will provide both our year-end results as well as guidance for 2026. So thank you all for joining us this morning.
