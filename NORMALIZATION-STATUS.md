...
| Compensation parsing (100 S&P 500) | **86% GOOD** | 0 all-null, 0 errors, 14 no-execs |
...
| COMP-01 | Fix 11 compensation bugs + scale fixes | **Code done, needs manual verification** | 56/56 tests pass; 86% of 100 S&P 500 tickers parse successfully (was 54%); 30-company manual check pending |
