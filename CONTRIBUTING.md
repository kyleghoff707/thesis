# Contributing to Thesis CLI

Thanks for considering a contribution. Thesis CLI is an early-stage open-source project; bug reports, documentation improvements, and well-scoped feature ideas are all welcome.
...
The hosted Thesis website and API are **not part of this repo**. They are maintained separately by the author. PRs to add or modify hosted-service functionality won't be accepted; if you need server functionality, propose it as an issue first.
