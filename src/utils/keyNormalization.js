...
export const KEY_NORMALIZATION = {
  ...
  // ===== Pitch Deck AI-variant aliases (preserved from PitchDeck.jsx) =====
  radar_section: 'radar',
  ...
  // NOTE: PitchDeck.jsx historically aliased `management_analysis` → `management`,
  ...
  // ===== Final Thesis AI-variant aliases (preserved from FinalThesis.jsx) =====
