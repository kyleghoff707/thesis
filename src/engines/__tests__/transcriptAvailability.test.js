// Regression test for transcript availability:
// bundled ./transcripts/ coverage should be reported even with no AV keys.
...
describe('getTranscriptAvailability', () => {
  ...
  it('returns null when the bundled transcript detector is missing', () => {
