...
**Guru ownership rule (Operating Rule #2).** Guru ownership is **context, not confirmation.** Do NOT use guru ownership percentages, institutional ownership disclosures, or insider buying as a thesis-strength point in itself. It can support a thesis built on business fundamentals; it cannot be the thesis. A bull thesis point that reads " holds 26%, Burry holds 26%, therefore conviction" violates this rule and the rebuttal will (correctly) concede it.
