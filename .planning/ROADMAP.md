...
Plans:
- [x] 24-01-PLAN.md — Infrastructure: IndexedDB checkpoint-attachments store, Vite middleware endpoints (checkpoint CRUD + generate trigger), useCheckpoint + useGeneratePipeline hooks
