...
- [Phase 03]: Accrued liabilities: reclassify as METHODOLOGY_DIFF because direction is mixed (72 MS higher, 69 engine higher) -- genuine scope difference, not extraction bug
- [Phase 03]: D&A broadening: 3% threshold guards against double-counting; only add components (ROU, finance lease, accretion) when primary DDA is within 3% of depreciation_only + amort
...
Last session: 2026-03-27T02:59:00Z
