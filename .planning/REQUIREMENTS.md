...
- [x] **ENGINE-02**: Residual "Other" field computation with per-company-year precondition gate — only compute residuals when named item coverage >= 95% for that record
